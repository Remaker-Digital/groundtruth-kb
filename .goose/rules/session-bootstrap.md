...
- Both Prime Builder and Loyal Opposition startup procedures load
  `.goose/rules/canonical-terminology.md` so the live glossary is available
...
7. In Loyal Opposition mode, process latest `NEW` or `REVISED` entries from
   oldest to newest using `.goose/rules/file-bridge-protocol.md`.
...
10. Confirm **global baseline** startup surfaces loaded (see
   ...
   - `.goose/rules/operating-role.md` guidance
   - `.goose/rules/canonical-terminology.md` (core primer subset only)
...
12. For substantial LO review work inside an opened activity envelope, use:
   - `.goose/rules/review-checklists.md`
   - `.goose/rules/template-code-review.md`
   - `.goose/rules/template-decision-memo.md`
...
.goose/rules/canonical-terminology.md (core primer subset),
.goose/rules/file-bridge-protocol.md,
...
- The `.goose` skills and hook changes are local-only because `.goose` is git-ignored in this repo.
