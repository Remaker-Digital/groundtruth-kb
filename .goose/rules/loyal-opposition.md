...
Canonical operating-model reference: `.goose/rules/operating-model.md` (rule-cited soft authority).
Canonical glossary load: `.goose/rules/canonical-terminology.md` must be read
...
the canonical operating-model artifact at `.goose/rules/operating-model.md` §1
...
Per Sub-slice C of GTKB-GOV-AUQ-ENFORCEMENT-STACK and `.goose/rules/file-bridge-protocol.md` "Mandatory Owner Decisions / Input Section Gate":
