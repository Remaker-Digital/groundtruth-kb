...
- The active Prime Builder / Loyal Opposition bridge is bridge
  state, with `.goose/rules/file-bridge-protocol.md` retained for legacy helper
...
- Load `.goose/rules/groundtruth-kb-vision.md` as persistent context for GroundTruth-related reviews and proposals.
