...
cap in `.goose/hooks/assertion-check.py`. When the retention cap is widened
...
One assertion per call per the one-at-a-time owner-action protocol
...
`.goose/hooks/assertion-check.py` reads the latest run summary and surfaces
...
- `DCL-CONCEPT-ON-CONTACT-001` — load-bearing concepts have canonical glossary entries; see `.goose/rules/canonical-terminology.md`.
...
Generated at: content-addressed 3c627a460496
Canonical source: .harness-baseline-configuration/skills/gtkb-assertion-triage/SKILL.md
Canonical source sha256: 3c627a46049669e607e7645dde0c016c62533b15d7a0cec79850e65aff3a1212
