...
export function registerInboxHandlers() {
  ...
  POST('/api/admin/conversations/:id/resolve', () => ({
    status: 200, body: { success: true, message: 'Conversation resolved' },
  }));
  POST('/api/admin/conversations/:id/escalate', () => ({
    status: 200, body: { success: true, message: 'Conversation escalated' },
  }));
  POST('/api/admin/conversations/:id/archive', () => ({
    status: 200, body: { success: true, message: 'Conversation archived' },
  }));
  POST('/api/admin/conversations/:id/unarchive', () => ({
    status: 200, body: { success: true, message: 'Conversation unarchived' },
  }));
