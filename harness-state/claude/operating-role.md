...
This file is the Claude Code harness-local durable next-session role record
for GroundTruth-KB. Session startup must resolve the active harness's durable
...
configured or present, startup falls back to `.claude/rules/operating-role.md`.
