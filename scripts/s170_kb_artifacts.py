...
config_kb_tests = [
    ...
    ("test_config_field_produces_authority_block", "TestConfigAuthoritySystemPrompt", "SPEC-1713",
     "Config authority block appears in prompt when config fields are set"),
    ("test_empty_config_no_authority_block", "TestConfigAuthoritySystemPrompt", "SPEC-1713",
     "No authority block when all config fields are empty/default"),
    ("test_authority_block_lists_each_field", "TestConfigAuthoritySystemPrompt", "SPEC-1713",
     "Authority block lists each configured field name"),
    ("test_authority_block_override_wording", "TestConfigAuthoritySystemPrompt", "SPEC-1713",
     "Authority block uses 'override' wording"),
    ("test_authority_block_position_after_persona", "TestConfigAuthoritySystemPrompt", "SPEC-1713",
     "Authority block placed after persona section in prompt"),
    ("test_multiple_config_fields_all_listed", "TestConfigAuthoritySystemPrompt", "SPEC-1713",
     "Multiple configured fields are all listed in authority block"),
    ("test_partial_config_only_set_fields_listed", "TestConfigAuthoritySystemPrompt", "SPEC-1713",
     "Only explicitly set fields appear in authority block"),
    ("test_config_authority_with_custom_instructions", "TestConfigAuthoritySystemPrompt", "SPEC-1713",
     "Custom instructions config field triggers authority block"),
    ("test_config_authority_with_brand_name", "TestConfigAuthoritySystemPrompt", "SPEC-1713",
     "Brand name config field triggers authority block"),
    ("test_config_authority_with_language", "TestConfigAuthoritySystemPrompt", "SPEC-1713",
     "Language config field triggers authority block"),
    # TestKBConflictScanner (SPEC-1714)
    ("test_no_conflicts_when_config_empty", "TestKBConflictScanner", "SPEC-1714",
     "Scanner returns no conflicts when config fields are empty"),
    ("test_detects_language_conflict", "TestKBConflictScanner", "SPEC-1714",
     "Scanner detects KB article conflicting with language config"),
    ("test_detects_brand_name_conflict", "TestKBConflictScanner", "SPEC-1714",
     "Scanner detects KB article conflicting with brand name config"),
    ("test_detects_persona_conflict", "TestKBConflictScanner", "SPEC-1714",
     "Scanner detects KB article conflicting with persona config"),
    ("test_multiple_conflicts_detected", "TestKBConflictScanner", "SPEC-1714",
     "Scanner detects multiple simultaneous conflicts"),
    ("test_no_false_positive_on_unrelated_article", "TestKBConflictScanner", "SPEC-1714",
     "Scanner does not flag unrelated KB articles as conflicts"),
    ("test_conflict_includes_article_id", "TestKBConflictScanner", "SPEC-1714",
     "Conflict result includes the conflicting article ID"),
    ("test_conflict_includes_config_field_name", "TestKBConflictScanner", "SPEC-1714",
     "Conflict result includes the authoritative config field name"),
    ("test_conflict_includes_severity", "TestKBConflictScanner", "SPEC-1714",
     "Conflict result includes severity level"),
    ("test_scanner_handles_empty_kb", "TestKBConflictScanner", "SPEC-1714",
     "Scanner handles empty KB article list gracefully"),
    ("test_scanner_case_insensitive_matching", "TestKBConflictScanner", "SPEC-1714",
     "Scanner matches conflicts case-insensitively"),
    ("test_scanner_partial_match_on_instruction_keywords", "TestKBConflictScanner", "SPEC-1714",
     "Scanner detects partial instruction keyword matches"),
    # TestConfigConflictWarningUI (SPEC-1715)
    ("test_warning_banner_when_conflicts_detected", "TestConfigConflictWarningUI", "SPEC-1715",
     "Warning banner shown when config-vs-KB conflicts detected"),
    ("test_no_warning_when_no_conflicts", "TestConfigConflictWarningUI", "SPEC-1715",
     "No warning banner when no conflicts exist"),
    ("test_warning_lists_conflicting_articles", "TestConfigConflictWarningUI", "SPEC-1715",
     "Warning banner lists the conflicting KB article titles"),
    ("test_warning_links_to_kb_page", "TestConfigConflictWarningUI", "SPEC-1715",
     "Warning includes link to KB page for resolution"),
    ("test_warning_on_configuration_page", "TestConfigConflictWarningUI", "SPEC-1715",
     "Configuration page shows conflict warning"),
    ("test_warning_on_kb_page", "TestConfigConflictWarningUI", "SPEC-1715",
     "Knowledge Base page shows conflict warning"),
    ("test_warning_dismissible", "TestConfigConflictWarningUI", "SPEC-1715",
     "Warning banner can be dismissed"),
    ("test_warning_reappears_on_new_conflict", "TestConfigConflictWarningUI", "SPEC-1715",
     "Warning reappears when new conflict is introduced"),
    ("test_warning_severity_color_coding", "TestConfigConflictWarningUI", "SPEC-1715",
     "Warning uses appropriate severity color coding"),
    ("test_warning_config_field_name_displayed", "TestConfigConflictWarningUI", "SPEC-1715",
     "Warning shows which config field is authoritative"),
    # TestConfigVsKBIntegration
    ("test_full_flow_config_set_then_kb_conflict_detected", "TestConfigVsKBIntegration", "SPEC-1713",
     "Full integration: config set → KB article added → conflict detected → warning shown"),
    ("test_full_flow_conflict_resolved_by_removing_article", "TestConfigVsKBIntegration", "SPEC-1714",
     "Full integration: conflict resolved by removing conflicting KB article"),
    ("test_full_flow_conflict_resolved_by_clearing_config", "TestConfigVsKBIntegration", "SPEC-1714",
     "Full integration: conflict resolved by clearing config field"),
    ("test_authority_rule_in_prompt_with_active_conflicts", "TestConfigVsKBIntegration", "SPEC-1713",
     "Authority rule present in prompt even when KB conflicts exist"),
    ("test_scanner_invoked_on_config_save", "TestConfigVsKBIntegration", "SPEC-1714",
     "Conflict scanner invoked automatically on config save"),
    ("test_scanner_invoked_on_kb_article_save", "TestConfigVsKBIntegration", "SPEC-1714",
     "Conflict scanner invoked automatically on KB article save"),
    ("test_prompt_builder_uses_config_over_kb", "TestConfigVsKBIntegration", "SPEC-1713",
     "Prompt builder uses config field value over conflicting KB content"),
    ("test_warning_count_matches_conflict_count", "TestConfigVsKBIntegration", "SPEC-1715",
...
email_tests = [
    ...
    ("test_template_does_not_contain_key_blocks", "TestWelcomeEmailTemplate", "SPEC-1723",
     "tests/multi_tenant/test_welcome_email.py",
     "Welcome email template does not contain Admin API Key or Widget Key blocks"),
    ("test_template_directs_to_admin_console_for_keys", "TestWelcomeEmailTemplate", "SPEC-1723",
     "tests/multi_tenant/test_welcome_email.py",
     "Welcome email directs users to admin dashboard for keys"),
    ("test_template_contains_admin_login_url", "TestWelcomeEmailTemplate", "SPEC-1724",
     "tests/multi_tenant/test_welcome_email.py",
     "Welcome email contains admin login URL"),
    ("test_template_admin_url_in_next_steps", "TestWelcomeEmailTemplate", "SPEC-1724",
     "tests/multi_tenant/test_welcome_email.py",
     "Welcome email Next Steps links to admin dashboard"),
    ("test_template_admin_url_button", "TestWelcomeEmailTemplate", "SPEC-1724",
     "tests/multi_tenant/test_welcome_email.py",
     "Welcome email has CTA button with admin URL and brand color"),
    ("test_acs_email_contains_admin_url", "TestSendWelcomeEmail", "SPEC-1724",
     "tests/multi_tenant/test_welcome_email.py",
     "ACS email body includes admin login URL"),
    ("test_explicit_admin_url_overrides_env", "TestSendWelcomeEmail", "SPEC-1724",
     "tests/multi_tenant/test_welcome_email.py",
...
print(f"  OK: {test_id - 9685 - len(config_kb_tests)} email test artifacts recorded (TEST-{9685 + len(config_kb_tests)}..TEST-{test_id - 1})")
