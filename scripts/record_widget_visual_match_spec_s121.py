...
specs = [
    # --- DARK MODE COLOR PALETTE ---
    {
        ...
        "assertions": [
            ...
            {"description": "colorAgentBubbleText in dark mode defaults to #f5f5f4 (was #F0F0F0)", "type": "requirement"},
        ],
    },
    ...
    # --- HEADER ---
    {
        ...
        "assertions": [
            ...
            {"description": "Default avatar (no URL) shows first 2 uppercase chars of headerTitle, not a person icon SVG", "type": "requirement"},
            {"description": "Header has 3-row layout: title / subtitle / (green dot + 'Online')", "type": "requirement"},
            {"description": "Header subtitle is configurable via widget_header_subtitle field (default: 'We typically reply within minutes')", "type": "requirement"},
            {"description": "Online indicator is on its own row with green dot (6px) + 'Online' text at fontSize 10px, opacity 0.8", "type": "requirement"},
            {"description": "Title uses fontSize sm (12-14px), fontWeight 600, white color", "type": "requirement"},
            {"description": "Subtitle uses fontSize xs (11px), rgba(255,255,255,0.85), lineHeight 1.3", "type": "requirement"},
        ],
    },
    ...
    # --- GREETING PRESENTATION ---
    {
        ...
        "assertions": [
            {"description": "Greeting message renders as a left-aligned agent message bubble with avatar, not centered welcome text", "type": "requirement"},
            {"description": "Greeting avatar is 28px (avatarSizeSm), red primary bg, 'AR' text (2 chars)", "type": "requirement"},
            {"description": "Greeting bubble has bg colorAgentBubble, border 1px solid colorAgentBubbleBorder, borderRadius '4px 16px 16px 16px'", "type": "requirement"},
            ...
            {"description": "Quick actions appear below the greeting bubble, not below centered text", "type": "requirement"},
        ],
    },
    ...
    # --- QUICK ACTION PILLS ---
    {
        ...
        "assertions": [
            {"description": "Quick action pills use horizontal inline layout (flex-row wrap), not vertical column", "type": "requirement"},
            ...
            {"description": "Pill background is colorSurface, text color is colorAgentBubbleText", "type": "requirement"},
        ],
    },
    ...
    # --- MESSAGE BUBBLES ---
    {
        ...
        "assertions": [
            {"description": "Customer bubble borderRadius is '16px 16px 4px 16px' (top-left, top-right, bottom-right flat, bottom-left)", "type": "requirement"},
            {"description": "Agent bubble borderRadius is '4px 16px 16px 16px' (top-left flat, top-right, bottom-right, bottom-left)", "type": "requirement"},
            ...
            {"description": "Agent bubble has explicit border: 1px solid colorAgentBubbleBorder (new token needed)", "type": "requirement"},
            {"description": "Message text fontSize is xs (11-12px) to match mockup density (was 14px/fontSizeMd)", "type": "requirement"},
        ],
    },
    ...
    # --- INPUT BAR ---
    {
        ...
        "assertions": [
            {"description": "Input field has visible background (colorSurface in dark = #292524) and borderRadius (8px or config-based)", "type": "requirement"},
            {"description": "Input bar background is #0c0a09 in dark mode (was colorBackground #1c1917)", "type": "requirement"},
            {"description": "Input bar top border uses colorBorder (#44403c dark)", "type": "requirement"},
            {"description": "Send button is always primaryColor (#ff3621) regardless of input state (was colorSurface when empty)", "type": "requirement"},
            {"description": "Send icon is paper-plane line-stroke SVG (line x1=22 y1=2 x2=11 y2=13 + polygon), not filled arrow", "type": "requirement"},
            {"description": "Input field padding is '8px 14px' with fontSize 12px", "type": "requirement"},
            {"description": "Default input placeholder is 'Type your message...' (was 'Type a message...')", "type": "requirement"},
        ],
    },
    ...
    # --- BRANDING FOOTER ---
    {
        ...
        "assertions": [
            {"description": "'Powered by' text in colorTextMuted, 'Agent Red' in fontWeight 600 + primaryColor (#ff3621)", "type": "requirement"},
    ...
    # --- NEW TOKEN: AGENT BUBBLE BORDER ---
    {
        ...
        "assertions": [
            ...
            {"description": "Configurable via widget_agent_bubble_border_color config field (future)", "type": "requirement"},
        ],
    },
    ...
    # --- NEW CONFIG FIELD: HEADER SUBTITLE ---
    {
        ...
        "assertions": [
            {"description": "widget_header_subtitle field added to WidgetConfig interface (string | null)", "type": "requirement"},
            {"description": "Default value: 'We typically reply within minutes'", "type": "requirement"},
            {"description": "Rendered as second line in header below title, above online indicator", "type": "requirement"},
    ...
    # --- INPUT BAR DARK BG TOKEN ---
    {
        ...
        "assertions": [
            ...
            {"description": "InputBar component uses colorInputBarBg instead of colorBackground", "type": "requirement"},
        ],
    },
]
