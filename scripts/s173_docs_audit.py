...
specs = [
    (
        "SPEC-1725",
        "DOC: Fix rate limit values in overview.md - all tiers 500 RPM",
    ...
    (
        "SPEC-1726",
        "DOC: Fix auth header format in setup.md - X-API-Key not Bearer",
    ...
    (
        "SPEC-1727",
        "DOC: Update changelog through v1.82.1",
    ...
    (
        "SPEC-1728",
        "DOC: Fix welcome email description in setup.md",
    ...
    (
        "SPEC-1729",
        "DOC: Replace click Save with auto-save in save-and-activate.md",
    ...
    (
        "SPEC-1730",
        "DOC: Add widget_launcher_color to widget-appearance.md",
    ...
    (
        "SPEC-1731",
        "DOC: Fix analytics chart name - Daily usage not Conversation Volume",
    ...
    (
        "SPEC-1732",
        "DOC: Update team-management.md role access table",
    ...
    (
        "SPEC-1733",
        "DOC: Update business-policies.md - policies moved to KB page",
    ...
    (
        "SPEC-1734",
        "DOC: Update brand-and-tone.md - merged into Agent identity",
    ...
    (
        "SPEC-1735",
        "DOC: Add config-vs-KB authority to conflict-scanner.md",
    ...
    (
        "SPEC-1736",
        "DOC: Add widget behavior features - exit-intent scroll-depth panel dimensions",
    ...
    (
        "SPEC-1737",
        "DOC: Fix fields.yaml doc_link domain - docs.agentred.ai to agentredcx.com",
    ...
    (
        "SPEC-1738",
        "DOC: Fix tier-upgrades.md rate limit claim",
    ...
    (
        "SPEC-1739",
        "DOC: Update custom-instructions.md for Agent identity merge",
