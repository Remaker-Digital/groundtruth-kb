...
DCL_BODY = (
    ...
    "\n"
    "1. harness-state/harness-registry.json - find the active harness record with the needed durable role.\n"
    "2. Use the registry record's harness_name and invocation surface to resolve the command handle.\n"
    "\n"
    ...
    "harness-state/harness-registry.json. The check uses set-membership against the receiver's role set.\n"
    "\n"
    ...
    "\n"
    "1. grep scripts/gtkb_dispatcher_daemon.py for _invert_identities and _resolve_dispatch_target - "
    ...
    "3. grep scripts/gtkb_dispatcher_daemon.py and both SessionStart hooks for "
