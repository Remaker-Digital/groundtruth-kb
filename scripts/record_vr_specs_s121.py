...
specs = [
    # --- HEADER BAR ---
    {
        ...
        "assertions": [
            ...
            {"description": 'Brand name "agent_red" displayed: "agent_" in white, "red" in brand color (#ff3621)', "type": "visual"},
    ...
    },
    {
        ...
        "assertions": [
            ...
            {"description": "Action icons row: 5 icons (docs/book, chat, comments, settings/gear, exit/logout)", "type": "visual"},
    ...
    # --- NAVBAR ---
    {
        ...
        "assertions": [
            ...
            {"description": 'First AI config link: "Agent configuration" partially visible at bottom', "type": "visual"},
        ],
    },
    {
        ...
        "assertions": [
            {"description": "Background is dark chrome color (#0c0a09)", "type": "visual"},
            {"description": "Navigation links: Knowledge base, Quick actions, Widget configuration, Setup wizard", "type": "visual"},
            {"description": "Widget configuration link is ACTIVE: highlighted with brand-red icon, lighter text, subtle background tint", "type": "visual"},
            {"description": 'Three action buttons at bottom: "Deactivate" (red bg), "Discard" (dark bg, light border), "Roll back" (dark bg, light border)', "type": "visual"},
        ],
    },
    {
        ...
        "assertions": [
            ...
            {"description": 'Copyright notice: "2026 Remaker Digital, a DBA of VanDusen & Palmeter, LLC. All rights reserved"', "type": "visual"},
        ],
    },
    ...
    # --- MAIN CONTENT (form column) ---
    {
        ...
        "assertions": [
            ...
            {"description": 'Subtitle: "Customize how your chat widget looks and behaves" in stone-400 gray', "type": "visual"},
            {"description": 'Installation card starts: Paper section with "Installation" heading + help (?) icon', "type": "visual"},
            {"description": "Paper card has surface background (#292524), border in stone-700 (#44403c), rounded corners (8px)", "type": "visual"},
        ],
    },
    {
        ...
        "assertions": [
            ...
            {"description": 'Field: "Widget key" label in white, value in monospace code font inside dark input', "type": "visual"},
            {"description": 'Field: "API URL" label in white, value in monospace showing gateway FQDN', "type": "visual"},
            {"description": 'Helper text: "Shopify merchants: paste this URL into the..." in stone-400', "type": "visual"},
    ...
    },
    {
        ...
        "assertions": [
            {"description": 'Widget key field continues: shows key tail + copy icon + "Rotate key" button (outlined, blue text)', "type": "visual"},
    ...
    },
    {
        ...
        "assertions": [
            {"description": "Embed code section with instruction text about pasting before closing </body> tag", "type": "visual"},
            {"description": "Code block: dark background with <script> tag in monospace font showing src, data-widget-key, data-api-url attributes", "type": "visual"},
    ...
    },
    {
        ...
        "assertions": [
            ...
            {"description": 'First field row: "Header left color" and "Header right color" labels visible', "type": "visual"},
    ...
    # --- PREVIEW PANEL (production only -- removed in local build) ---
    {
        ...
        "assertions": [
            ...
            {"description": "Mock browser chrome: three colored dots (red/yellow/green) in top-left of preview area", "type": "visual"},
            {"description": "Red header bar (#ff3621 gradient) with 'Support' heading visible below mock chrome", "type": "visual"},
        ],
    },
    {
        ...
        "assertions": [
            {"description": 'Support header continues: "We typically reply within minutes", green "Online" indicator', "type": "visual"},
            {"description": '"Today" divider text in gray', "type": "visual"},
            {"description": 'Agent message bubble (dark bg): "Hi there! How can I help you today?" with red AR avatar', "type": "visual"},
            {"description": 'Quick action chips: "Product question" and partial "Shipping info" visible', "type": "visual"},
        ],
    },
    {
        ...
        "assertions": [
            ...
            {"description": 'User message bubble (red/brand bg): "Hi, I have a question about m..." (truncated)', "type": "visual"},
            {"description": 'Agent response bubble: "Of course! I\'d be happy to help. Could you share your order number?"', "type": "visual"},
    ...
    },
    {
        ...
        "assertions": [
            ...
            {"description": '"Powered by Agent Red" text with brand-colored "Agent Red" link below input', "type": "visual"},
        ],
    },
    ...
    # --- LAYOUT STRUCTURE (structural, not tile-based) ---
    {
        ...
        "assertions": [
            {"description": "Page uses two-column layout: left form column (~55% width) + right preview column (~45% width)", "type": "visual"},
            {"description": "Left column contains: Installation card, Embed code, Appearance section (scrollable)", "type": "visual"},
            {"description": 'Right column contains: "Live preview" Paper card with sticky positioning', "type": "visual"},
            {"description": "Preview panel has mock browser chrome, chat conversation mockup, message input, and FAB launcher", "type": "visual"},
