...
MAPPINGS: list[tuple[str, str, str, str, str, str]] = [
    ...
    (
        ...
        "high",
        "Analytics merged into Dashboard — period SegmentedControl",
    ),
    (
        "SPEC-0895",
        "tests/e2e/test_dashboard_page.py",
    ...
    (
        ...
        "test_period_selector_options",
        "high",
        "Dashboard SegmentedControl options",
    ),
    # Configuration
    (
        "SPEC-0882",
        ...
        "TestDropdowns",
        "test_formality_selector_exists",
        "high",
        "Formality selector",
    ),
    (
    ...
    (
        ...
        "test_page_heading_visible",
        "high",
        "KB page title (duplicate spec)",
    ),
    # Memory & Privacy
    (
        "SPEC-0921",
        "tests/e2e/test_memory_privacy_page.py",
        "TestMemoryPrivacyStructure",
        "test_page_heading_visible",
        "high",
        "Memory & Privacy page title",
    ),
    (
        "SPEC-0922",
        "tests/e2e/test_memory_privacy_page.py",
        ...
        "test_page_heading_visible",
        "high",
        "Memory & Privacy page title (duplicate spec)",
    ),
    # Team
    (
        "SPEC-0933",
    ...
    (
        ...
        "high",
        "Static/AI-generated SegmentedControl",
    ),
    ...
    (
        ...
        "tests/e2e/test_configuration_page.py",
        "TestConfigInputFields",
        "test_brand_voice_input",
        "high",
        "Brand voice input field",
    ),
    (
        "SPEC-0884",
        "tests/e2e/test_configuration_page.py",
        "TestConfigInputFields",
        "test_return_window_input",
        "high",
        "Return window input field",
    ),
    (
        "SPEC-0885",
        "tests/e2e/test_configuration_page.py",
        "TestConfigInputFields",
        "test_refund_policy_input",
        "high",
        "Refund policy input field",
    ),
    (
        "SPEC-0886",
        "tests/e2e/test_configuration_page.py",
        "TestConfigInputFields",
        "test_shipping_policy_input",
        "high",
        "Shipping policy input field",
    ),
    (
        "SPEC-0887",
        "tests/e2e/test_configuration_page.py",
        "TestConfigInputFields",
        "test_notification_email_input",
        "high",
    ...
    (
        ...
        "high",
        "Max turns input field",
    ),
    (
        "SPEC-0890",
        "tests/e2e/test_configuration_page.py",
        "TestConfigInputFields",
        "test_primary_language_input",
        "high",
    ...
    (
        ...
        "test_cancel_button",
        "high",
        "Cancel button (save modal)",
    ),
    # ── NEW TESTS: Knowledge Base form fields ───────────────────────────────
    (
        "SPEC-0902",
        "tests/e2e/test_knowledge_base_page.py",
        "TestArticleFormFields",
        "test_title_input",
        "high",
        "KB article Title input",
    ),
    (
        "SPEC-0903",
        "tests/e2e/test_knowledge_base_page.py",
    ...
    (
        "SPEC-0916",
        "tests/e2e/test_memory_privacy_page.py",
        "TestMemoryPrivacyFields",
        "test_data_retention_period_input",
        "high",
    ...
    (
        ...
        "tests/e2e/test_memory_privacy_page.py",
        "TestMemoryPrivacyFields",
        "test_identification_mode_segmented_control",
        "high",
        "Identification mode SegmentedControl",
    ),
    # ── NEW TESTS: Billing page ─────────────────────────────────────────────
    (
        "SPEC-0875",
        "tests/e2e/test_billing_page.py",
        "TestBillingPageStructure",
    ...
    (
        "SPEC-0897",
        "tests/e2e/test_inbox_page.py",
        "TestInboxPageStructure",
        "test_category_input",
        "high",
        "Inbox Category input",
    ),
    (
        "SPEC-0898",
        "tests/e2e/test_inbox_page.py",
        "TestInboxPageStructure",
        "test_assign_to_agent_input",
        "high",
        "Inbox Assign to agent input",
    ),
    (
        "SPEC-0899",
        "tests/e2e/test_inbox_page.py",
    ...
    (
        ...
        "tests/e2e/test_inbox_page.py",
        "TestInboxPageStructure",
        "test_status_segmented_control",
        "high",
        "Inbox status SegmentedControl",
    ),
    # ── NEW TESTS: Quick Actions page ───────────────────────────────────────
    (
        "SPEC-0924",
        "tests/e2e/test_quick_actions_page.py",
        "TestQuickActionsFields",
        "test_button_label_input",
        "high",
        "QA Button label input",
    ),
    (
        "SPEC-0925",
        "tests/e2e/test_quick_actions_page.py",
        "TestQuickActionsFields",
        "test_prompt_template_input",
        "high",
        "QA Prompt template input",
    ),
    (
        "SPEC-0926",
        "tests/e2e/test_quick_actions_page.py",
    ...
    (
        ...
        "test_page_title",
        "high",
        "QA page title (duplicate spec)",
    ),
    (
        "SPEC-0931",
        "tests/e2e/test_quick_actions_page.py",
        "TestQuickActionsTabs",
        "test_prompts_tab",
        "high",
        "QA prompts tab",
    ),
    ...
    (
        "SPEC-0901",
        "tests/e2e/test_integrations_page.py",
        "TestIntegrationsPageStructure",
        "test_page_title",
        "high",
    ...
    (
        ...
        "medium",
        "Onboarding wizard replaced — config page loads",
    ),
]
