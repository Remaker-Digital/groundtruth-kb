...
tests = [
    ...
    (
        0,
        "SPEC-1606",
        "TestSpec1606BillableClassification",
    ...
    (
        4,
        "SPEC-1607",
        "TestSpec1607InboxZeroMessageExclusion",
    ...
    (
        6,
        "SPEC-1608",
        "TestSpec1608DashboardZeroMessageExclusion",
    ...
    (
        7,
        "SPEC-1611",
        "TestSpec1611IssueReportEscalation",
    ...
    (
        8,
        "SPEC-1623",
        "TestSpec1623PreAuthPeriodicCleanup",
    ...
    (
        15,
        "SPEC-1636",
        "TestSpec1636NoCentralizedUserDB",
    ...
    (
        18,
        "SPEC-1637",
        "TestSpec1637SuperadminContactInfo",
    ...
    (
        21,
        "SPEC-1638",
        "TestSpec1638DashboardBillableTotal",
    ...
    (
        23,
        "SPEC-1639",
        "TestSpec1639ResolutionRateBillableOnly",
    ...
    (
        25,
        "SPEC-1640",
        "TestSpec1640InitializedTenantWizard",
    ...
    (
        29,
        "SPEC-1647",
        "TestSpec1647ServiceMessageFormat",
    ...
    (
        36,
        "SPEC-1625",
        "TestSpec1059RateLimitAtomicity",
