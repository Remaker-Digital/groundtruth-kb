...
VR_CONVERSIONS = {
    ...
    "VR-agentconfig-s0-topleft": [
        {
            ...
            "pattern": "Title order.*Agent configuration",
        },
    ...
    "VR-widget-s0-header-right": [
        {
            "type": "grep",
            "file": "admin/standalone/layouts/StandaloneLayout.tsx",
            "pattern": "Storefront|external-link|storefront",
        },
    ...
    "VR-widget-s0-nav-bottom": [
        ...
        {"type": "grep", "file": "admin/standalone/layouts/StandaloneLayout.tsx", "pattern": "Billing"},
        {
            "type": "grep",
            "file": "admin/standalone/layouts/StandaloneLayout.tsx",
            "pattern": "Agent Red Customer Experience",
        },
    ],
...
def main():
    ...
    for spec_id, assertions in VR_CONVERSIONS.items():
        # Get spec version
        row = c.execute("SELECT version FROM current_specifications WHERE id = ?", (spec_id,)).fetchone()
        if not row:
