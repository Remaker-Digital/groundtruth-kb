...
TESTS = [
    ...
    (
        "TEST-3026",
        "QA Prompt Library tab visible",
        "SPEC-1652",
        "TestTabs",
        "test_prompt_library_tab_visible",
        "Prompt Library tab is visible and contains expected text",
    ),
    (
        "TEST-3027",
        "QA Page Assignments tab visible",
        "SPEC-1652",
        "TestTabs",
        "test_page_assignments_tab_visible",
        "Page Assignments tab is visible",
    ),
    (
        "TEST-3028",
        "QA tab switching works",
        "SPEC-1652",
        "TestTabs",
    ...
    (
        "TEST-3030",
        "QA starter example buttons",
        "SPEC-1652",
        "TestEmptyState",
        "test_starter_example_buttons",
        "Starter example buttons visible in empty state",
    ),
    # TestCreateButton (2 tests)
    (
        "TEST-3031",
        "QA create button visible",
        "SPEC-1652",
        "TestCreateButton",
        "test_create_button_visible",
        "Create quick action button is visible on page",
    ),
    (
        "TEST-3032",
        "QA create button opens modal",
        "SPEC-1652",
        "TestCreateButton",
        "test_create_button_opens_modal",
        "Clicking create button opens the action form modal",
    ),
    # TestCreateEditModal (8 tests)
    (
        "TEST-3033",
        "QA modal has label input",
        "SPEC-1652",
        "TestCreateEditModal",
        "test_modal_has_label_input",
        "Modal contains a text input for action label",
    ),
    (
        "TEST-3034",
        "QA modal has prompt textarea",
        "SPEC-1652",
        "TestCreateEditModal",
        "test_modal_has_prompt_textarea",
        "Modal contains a textarea for action prompt",
    ),
    (
        "TEST-3035",
        "QA modal has template variables",
        "SPEC-1652",
        "TestCreateEditModal",
        "test_modal_has_template_variables",
        "Modal shows template variable buttons (customer_name, etc.)",
    ),
    (
        "TEST-3036",
        "QA modal has icon input",
        "SPEC-1652",
        "TestCreateEditModal",
        "test_modal_has_icon_input",
        "Modal contains an icon/emoji input field",
    ),
    (
        "TEST-3037",
        "QA modal has emoji grid",
        "SPEC-1652",
        "TestCreateEditModal",
        "test_modal_has_emoji_grid",
        "Modal shows emoji picker grid for icon selection",
    ),
    (
        "TEST-3038",
        "QA modal has active toggle",
        "SPEC-1652",
        "TestCreateEditModal",
        "test_modal_has_active_toggle",
        "Modal contains an Active switch/toggle",
    ),
    (
        "TEST-3039",
        "QA modal has cancel and submit buttons",
        "SPEC-1652",
        "TestCreateEditModal",
        "test_modal_has_cancel_and_submit",
        "Modal has Cancel and Create/Save buttons",
    ),
    (
        "TEST-3040",
        "QA submit disabled without required fields",
        "SPEC-1652",
        "TestCreateEditModal",
        "test_submit_disabled_without_required_fields",
        "Submit button is disabled when label and prompt fields are empty",
    ),
    # TestCreateAction (3 tests)
    (
        "TEST-3041",
        "QA create action via modal",
        "SPEC-1652",
        "TestCreateAction",
        "test_create_action_via_modal",
        "Creating an action via modal form persists it in the table",
    ),
    (
        "TEST-3042",
        "QA create action shows preview",
        "SPEC-1652",
        "TestCreateAction",
        "test_create_action_shows_preview",
        "Newly created action shows in prompt preview area",
    ),
    (
        "TEST-3043",
        "QA create via starter example",
        "SPEC-1652",
        "TestCreateAction",
        "test_create_via_starter_example",
        "Clicking a starter example button creates that action",
    ),
    # TestTableStructure (2 tests)
    (
        "TEST-3044",
        "QA table headers present",
        "SPEC-1652",
        "TestTableStructure",
        "test_table_headers",
    ...
    (
        "TEST-3045",
        "QA action row with data",
        "SPEC-1652",
        "TestTableStructure",
        "test_action_row_with_data",
        "Table row displays action label and prompt text",
    ),
    # TestEditAction (2 tests)
    (
        "TEST-3046",
        "QA edit button opens modal",
        "SPEC-1652",
        "TestEditAction",
