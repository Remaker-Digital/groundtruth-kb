...
e2e_live_tests = [
    ...
    ("TEST-2992", "SPEC-1649", "KB-LIVE-01: Knowledge base page shows heading",
     "Verify the Knowledge Base admin page renders with correct heading via live Playwright.",
     "e2e", "tests/e2e_live/test_knowledge_base_live.py::TestKBPageStructure::test_kb_live_01_page_heading"),
    ("TEST-2993", "SPEC-1649", "KB-LIVE-02: Knowledge base page shows article list",
     "Verify KB page displays articles or empty state message.",
     "e2e", "tests/e2e_live/test_knowledge_base_live.py::TestKBPageStructure::test_kb_live_02_article_list_present"),
    ("TEST-2994", "SPEC-1649", "KB-LIVE-03: Knowledge base page has add button",
     "Verify KB page has an Add/Create/New article button.",
     "e2e", "tests/e2e_live/test_knowledge_base_live.py::TestKBPageStructure::test_kb_live_03_add_button_visible"),
    ("TEST-2995", "SPEC-1649", "KB-LIVE-04: Knowledge base page has search input",
     "Verify KB page has a search/filter input field.",
     "e2e", "tests/e2e_live/test_knowledge_base_live.py::TestKBPageStructure::test_kb_live_04_search_input_present"),

    # Quick Actions page (test_quick_actions_live.py)
    ("TEST-2996", "SPEC-1649", "QA-LIVE-01: Quick actions page shows heading",
     "Verify Quick Actions admin page renders with correct heading.",
     "e2e", "tests/e2e_live/test_quick_actions_live.py::TestQuickActionsPageStructure::test_qa_live_01_page_heading"),
    ("TEST-2997", "SPEC-1649", "QA-LIVE-02: Quick actions list or empty state",
     "Verify Quick Actions page shows action items or empty state.",
     "e2e", "tests/e2e_live/test_quick_actions_live.py::TestQuickActionsPageStructure::test_qa_live_02_action_list_or_empty"),
    ("TEST-2998", "SPEC-1649", "QA-LIVE-03: Quick actions add button present",
     "Verify Quick Actions page has Add/Create button.",
     "e2e", "tests/e2e_live/test_quick_actions_live.py::TestQuickActionsPageStructure::test_qa_live_03_add_action_button"),

    # Integrations page (test_integrations_live.py)
    ("TEST-2999", "SPEC-1649", "INT-LIVE-01: Integrations page loads",
     "Verify Integrations admin page loads with heading or main content.",
     "e2e", "tests/e2e_live/test_integrations_live.py::TestIntegrationsPageStructure::test_int_live_01_page_loads"),
    ("TEST-3000", "SPEC-1649", "INT-LIVE-02: Integrations page has items",
     "Verify Integrations page displays integration options or cards.",
     "e2e", "tests/e2e_live/test_integrations_live.py::TestIntegrationsPageStructure::test_int_live_02_has_integration_items"),
    ("TEST-3001", "SPEC-1649", "INT-LIVE-03: Integrations page no error state",
     "Verify Integrations page has no error message banner.",
     "e2e", "tests/e2e_live/test_integrations_live.py::TestIntegrationsPageStructure::test_int_live_03_no_error_state"),

    # Memory & Privacy page (test_memory_live.py)
    ("TEST-3002", "SPEC-1649", "MEM-LIVE-01: Memory page shows heading",
     "Verify Memory & Privacy admin page renders with correct heading.",
     "e2e", "tests/e2e_live/test_memory_live.py::TestMemoryPageStructure::test_mem_live_01_page_heading"),
    ("TEST-3003", "SPEC-1649", "MEM-LIVE-02: Memory page has settings sections",
     "Verify Memory page displays settings content (privacy, retention, etc.).",
     "e2e", "tests/e2e_live/test_memory_live.py::TestMemoryPageStructure::test_mem_live_02_has_settings"),
    ("TEST-3004", "SPEC-1649", "MEM-LIVE-03: Memory page has toggle or input controls",
     "Verify Memory page has interactive controls (toggles, checkboxes, inputs).",
     "e2e", "tests/e2e_live/test_memory_live.py::TestMemoryPageStructure::test_mem_live_03_has_toggle_or_input"),

    # Billing page (test_billing_live.py)
    ("TEST-3005", "SPEC-1649", "BILL-LIVE-01: Billing page shows heading",
     "Verify Billing admin page renders with heading.",
     "e2e", "tests/e2e_live/test_billing_live.py::TestBillingPageStructure::test_bill_live_01_page_heading"),
    ("TEST-3006", "SPEC-1649", "BILL-LIVE-02: Billing page shows plan info",
     "Verify Billing page displays plan tier or subscription information.",
     "e2e", "tests/e2e_live/test_billing_live.py::TestBillingPageStructure::test_bill_live_02_plan_info_displayed"),
    ("TEST-3007", "SPEC-1649", "BILL-LIVE-03: Billing page shows usage metrics",
     "Verify Billing page displays usage metrics or conversation stats.",
     "e2e", "tests/e2e_live/test_billing_live.py::TestBillingPageStructure::test_bill_live_03_usage_metrics_present"),
    ("TEST-3008", "SPEC-1649", "BILL-LIVE-04: Billing page has manage buttons",
     "Verify Billing page has management action buttons (Manage, Upgrade, etc.).",
     "e2e", "tests/e2e_live/test_billing_live.py::TestBillingPageStructure::test_bill_live_04_manage_buttons_present"),
]
...
widget_embed_tests = [
    ("TEST-3009", "SPEC-1649", "WE-LIVE-01: Widget.js serves JavaScript content-type",
     "Verify /widget.js returns HTTP 200 with JavaScript content-type.",
     "integration", "tests/live_api/test_widget_embed_live.py::TestWidgetBundleIntegrity::test_we_live_01_widget_js_serves_javascript"),
    ("TEST-3010", "SPEC-1649", "WE-LIVE-02: Widget bundle has runtime markers",
     "Verify widget.js contains expected runtime code (shadowRoot, AgentRed, createElement).",
     "integration", "tests/live_api/test_widget_embed_live.py::TestWidgetBundleIntegrity::test_we_live_02_widget_bundle_has_runtime"),
    ("TEST-3011", "SPEC-1649", "WE-LIVE-03: Widget bundle minimum size",
     "Verify widget.js is between 5KB and 500KB (not empty/corrupt).",
     "integration", "tests/live_api/test_widget_embed_live.py::TestWidgetBundleIntegrity::test_we_live_03_widget_bundle_minimum_size"),
    ("TEST-3012", "SPEC-1649", "WE-LIVE-04: Widget config accessible via widget key",
     "Verify /api/tenants/lookup responds 200 to valid widget key.",
     "integration", "tests/live_api/test_widget_embed_live.py::TestWidgetConfigEndpoint::test_we_live_04_widget_config_accessible"),
    ("TEST-3013", "SPEC-1649", "WE-LIVE-05: Widget config has appearance settings",
     "Verify widget config contains appearance fields (color, position, gradient, etc.).",
     "integration", "tests/live_api/test_widget_embed_live.py::TestWidgetConfigEndpoint::test_we_live_05_widget_config_has_appearance"),
    ("TEST-3014", "SPEC-1649", "WE-LIVE-06: Invalid widget key rejected",
     "Verify /api/tenants/lookup rejects invalid widget key with 401/403/404.",
     "integration", "tests/live_api/test_widget_embed_live.py::TestWidgetConfigEndpoint::test_we_live_06_invalid_widget_key_rejected"),
    ("TEST-3015", "SPEC-1649", "WE-LIVE-07: Widget.js responds with CORS headers",
     "Verify /widget.js CORS support for cross-origin embedding.",
     "integration", "tests/live_api/test_widget_embed_live.py::TestWidgetCORSHeaders::test_we_live_07_widget_js_cors"),
    ("TEST-3016", "SPEC-1649", "WE-LIVE-08: Chat API responds to OPTIONS preflight",
     "Verify /api/chat/conversations responds to OPTIONS preflight requests.",
     "integration", "tests/live_api/test_widget_embed_live.py::TestWidgetCORSHeaders::test_we_live_08_chat_api_cors"),
]
