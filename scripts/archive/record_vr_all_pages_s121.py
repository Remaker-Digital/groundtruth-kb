...
specs = [
    # --- DASHBOARD ---
    {
        ...
        "assertions": [
            ...
            {
                "description": '"Overview of your customer experience performance" subtitle in stone-400',
                "type": "visual",
            },
            {
                "description": 'First stat card: "Total conversations" with help (?) icon, large number, "Billable: N" subtext',
                "type": "visual",
            },
            {"description": 'Second row: "Customer satisfaction" stat card visible at bottom', "type": "visual"},
            {
                "description": "Stat cards use Paper styling: surface bg (#292524), stone-700 border, 8px radius",
                "type": "visual",
            },
        ],
    },
    # --- INBOX ---
    {
        ...
        "assertions": [
            ...
            {
                "description": 'Filter tabs: "All (N)", "Active (N)", "Esc (N)", "Resolved (N)", "Archived"',
                "type": "visual",
            },
            {
                "description": "Conversation list items with colored avatar circles (pink, green, etc.)",
                "type": "visual",
            },
            {
                "description": "Each conversation shows: truncated ID, message count, time ago, status badge",
                "type": "visual",
            },
    ...
    # --- TEAM MEMBERS ---
    {
        ...
        "assertions": [
            ...
            {
                "description": '"Manage team members, assign roles, and configure es..." subtitle in stone-400',
                "type": "visual",
            },
            ...
            {
                "description": 'First row: "Owner" label, email, "Superadmin" role badge in muted red/pink',
                "type": "visual",
            },
    ...
    # --- AGENT CONFIGURATION ---
    {
        ...
        "assertions": [
            ...
            {
                "description": 'First config row: "Default" with "Active" (green) and "Default" (gray) badges',
                "type": "visual",
            },
    ...
    # --- KNOWLEDGE BASE ---
    {
        ...
        "assertions": [
            ...
            {
                "description": '"Manage articles your AI uses to answer customers" subtitle in stone-400',
                "type": "visual",
            },
            ...
            {
                "description": 'Stat cards row: "Total articles", "Published", "Draft", "Archived", "Needs attention" with colored numbers',
                "type": "visual",
            },
    ...
    # --- QUICK ACTIONS ---
    {
        ...
        "assertions": [
            ...
            {
                "description": '"Manage contextual prompt buttons that appear in the chat widget" subtitle in stone-400',
                "type": "visual",
            },
            ...
            {
                "description": 'First row: red ? icon, "Product question", prompt text, green "Active" badge',
                "type": "visual",
            },
        ],
    },
    # --- INTEGRATIONS ---
    {
        ...
        "assertions": [
            ...
            {
                "description": '"Connect third-party services to extend your AI agent\'s capabilities." subtitle in stone-400',
                "type": "visual",
            },
            {"description": "First integration card: Shopify logo + name + help icon", "type": "visual"},
            {
                "description": '"Sync product catalog and customer data from your Shopify store." description',
                "type": "visual",
            },
    ...
    # --- MEMORY & PRIVACY ---
    {
        ...
        "assertions": [
            ...
            {
                "description": '"Configure how your AI remembers customers and handles their data" subtitle in stone-400',
                "type": "visual",
            },
            {
                "description": 'First Paper card: "Customer context" heading + "All tiers" green badge + "Disabled" toggle (right-aligned)',
                "type": "visual",
            },
            {
                "description": "Description text about structured customer profiles, preferences, account state",
                "type": "visual",
            },
            {
                "description": 'Second Paper card: "Conversation memory" heading + "All tiers" badge + "Enabled" toggle',
                "type": "visual",
            },
    ...
    # --- BILLING ---
    {
        ...
        "assertions": [
            ...
            {
                "description": 'Plan card: "Current plan" heading + help icon + "Professional" blue badge + "Active" green badge',
                "type": "visual",
            },
            {
                "description": 'Plan stats: "Included conversations N/mo", "Used this period N", "Remaining N"',
                "type": "visual",
            },
            {
                "description": 'Usage stat cards row: "Conversations used", "Pack balance", "Current overage", "Estimated overage cost"',
                "type": "visual",
            },
    ...
    # --- SHARED STYLE SPEC (applies to ALL pages) ---
    {
        ...
        "assertions": [
            ...
            {
                "description": "Navbar: dark chrome bg (#0c0a09), right border 0.8px #44403c, ~240px wide",
                "type": "visual",
            },
            {"description": "Main content area: page bg #1c1917 (rgb(28,25,23))", "type": "visual"},
            {
                "description": "Paper cards: surface bg #292524 (rgb(41,37,36)), border 0.8px #44403c, borderRadius 8px",
                "type": "visual",
            },
            {"description": "Page titles: large bold white text, followed by stone-400 subtitle", "type": "visual"},
            {
                "description": "Text hierarchy: white headings, stone-400 body/subtitles, stone-500 for muted text",
                "type": "visual",
            },
            {
                "description": "Active nav link: brand-red icon (#ff3621), lighter text, subtle background highlight",
                "type": "visual",
            },
            {
                "description": 'Footer: version "Agent Red Customer Experience vN.N.N" + copyright in stone-500',
                "type": "visual",
            },
            {
                "description": "Widget FAB launcher: red circle (#ff3621) with white chat icon, bottom-right corner",
                "type": "visual",
            },
        ],
    },
