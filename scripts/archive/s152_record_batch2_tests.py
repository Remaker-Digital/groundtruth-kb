...
TESTS_FILE1 = [
    ("SPEC-0584", "TestSpec0584SessionPersistence", [
        "test_session_token_is_jwt_with_expiry",
        "test_session_token_8_hour_ttl",
        "test_verify_session_token_returns_payload_not_consumed",
    ], "Session persistence across page refresh", "8-hour JWT token is reusable (not consumed on verify)"),

    ("SPEC-0585", "TestSpec0585SessionClearOnLogout", [
        "test_expired_token_returns_none",
        "test_invalid_token_returns_none",
        "test_empty_string_token_returns_none",
    ], "Session gate reappears on logout/cookie clear", "Invalid/expired tokens return None, forcing re-auth"),

    ("SPEC-1619", "TestSpec1619MagicLinkOriginUrl", [
    ...
    ], "Magic link URL preserves origin tenant", "URL includes ?tenant= matching origin context"),

    ("SPEC-0427", "TestSpec0427UnifiedAuthImplementation", [
        "test_middleware_resolves_auth_to_tenant_context",
        "test_mfa_module_exists_alongside_auth",
    ], "Auth/2FA/RBAC unified implementation", "TenantContext carries auth+role+tier; MFA module co-located"),

    ("SPEC-0498", "TestSpec0498CustomerIdentification", [
        "test_identity_preprocessor_exists",
        "test_identity_preprocessor_detects_email",
        "test_chat_models_support_visitor_identity",
    ], "Customer identification at chat start", "identity_preprocessor intercepts messages for email; VisitorIdentity model exists"),

    ("SPEC-0502", "TestSpec0502NameEmailRequired", [
        "test_email_extraction_from_message",
        "test_identity_action_types_include_email_received",
    ], "Name/email required before AI responds", "Email extraction works on direct and embedded email patterns"),

    ("SPEC-0505", "TestSpec0505OtpVerification", [
        "test_otp_pattern_is_6_digits",
        "test_otp_length_is_6",
        "test_otp_ttl_is_10_minutes",
        "test_max_otp_attempts_is_3",
    ], "OTP verification for Persistent Customer Memory", "6-digit OTP, 600s TTL, 3 max attempts"),

    ("SPEC-0506", "TestSpec0506VerifyIdentityLanguage", [
        "test_identity_action_has_system_message",
    ], "Ask to verify identity (no additional explanation)", "IdentityAction carries system_message for OTP flow"),

    ("SPEC-0507", "TestSpec0507AnonymousWarning", [
        "test_skip_phrases_include_guest_options",
        "test_skip_verification_action_has_warning_message",
    ], "Anonymous warning MUST NOT be skipped", "Skip phrases (skip/guest/no thanks) all trigger warning"),

    ("SPEC-0499", "TestSpec0499AnonymousDiscouraged", [
        "test_preprocessor_processes_all_unverified_messages",
        "test_otp_rate_limited_action_exists",
    ], "Anonymous sessions discouraged", "Preprocessor intercepts all unverified messages"),

    ("SPEC-0869", "TestSpec0869CamelCaseApiResponses", [
        "test_pydantic_models_use_camelcase_aliases",
        "test_api_versioning_header_names_are_kebab_case",
    ], "API responses use camelCase", "Pydantic models with aliases; headers use kebab-case"),

    ("SPEC-0453", "TestSpec0453ApiVersionTracking", [
    ...
    ], "API version numbering tracks product version", "SemVer API_VERSION + PRODUCT_VERSION; middleware adds both headers"),

    ("SPEC-0054", "TestSpec0054DraftUntilActivated", [
    ...
    ], "Config changes are drafts until activated", "ConfigState.DRAFT/ACTIVE; ActivationService.save_draft()/activate()"),

    ("SPEC-0479", "TestSpec0479NoActiveWithoutMandatory", [
        "test_activation_result_has_errors",
        "test_validation_result_has_hard_errors",
        "test_activation_service_has_validate_method",
    ], "No Active state without mandatory inputs", "activate() validates before promoting; ValidationResult blocks on hard errors"),

    ("SPEC-0064", "TestSpec0064ActiveMeansWidgetAvailable", [
        "test_activation_result_includes_activated_at",
        "test_config_state_active_value",
    ], "Active config means widget is live", "ConfigState.ACTIVE read by pipeline; ActivationResult records timestamp"),
]

# --- Email file ---
FILE2 = "tests/multi_tenant/test_email_spec_verification.py"
TESTS_FILE2 = [
    ("SPEC-0588", "TestSpec0588TitanSmtpPrimary", [
        "test_magic_link_email_tries_smtp_first",
        "test_welcome_email_tries_acs_or_smtp",
        "test_smtp_port_465_for_ssl",
    ], "Titan SMTP as primary email provider", "SMTP checked before ACS; port 465 with SMTP_SSL"),

    ("SPEC-0589", "TestSpec0589TitanSenderAddress", [
        "test_smtp_from_env_variable_used",
        "test_agent_red_branding_in_from_header",
    ], "Titan Email sender address configuration", "SMTP_FROM env var used; Agent Red in From header"),

    ("SPEC-0409", "TestSpec0409AcsFallback", [
        "test_acs_fallback_in_magic_link",
        "test_acs_fallback_in_api_key_reset",
    ], "Azure Communication Services as fallback", "ACS fallback in magic link and API key reset emails"),

    ("SPEC-0760", "TestSpec0760CredentialsInWelcomeEmail", [
    ...
    ], "Superadmin credentials in welcome email", "Welcome email includes superadmin_key and widget_key"),

    ("SPEC-0683", "TestSpec0683SignInLinkResolvesToAdmin", [
    ...
    ], "Sign-in link resolves to admin UI", "Template uses {admin_login_url}; builder returns admin console URL"),

    ("SPEC-0684", "TestSpec0684WelcomeEmailLogo", [
        "test_email_wrapper_has_logo_image",
        "test_email_wrapper_has_alt_text",
    ], "Welcome email displays Agent Red logo", "Email wrapper has <img> with logo and alt text"),

    ("SPEC-0689", "TestSpec0689KeyRegenerationNotice", [
        "test_welcome_email_has_regeneration_notice",
        "test_welcome_email_key_section_has_security_notice",
    ], "Key regeneration notice in welcome email", "Template includes 'regenerate' text and security notice"),

    ("SPEC-1628", "TestSpec1628ApiKeyResetWrapper", [
        "test_api_key_reset_imports_email_wrapper",
        "test_api_key_reset_formats_wrapper",
    ], "API key reset uses shared _EMAIL_WRAPPER", "_EMAIL_WRAPPER imported and formatted in API key email"),

    ("SPEC-1629", "TestSpec1629ApiKeyResetLoginButton", [
        "test_api_key_reset_has_admin_login_url_param",
        "test_api_key_reset_email_has_link",
    ], "API key reset email includes login link", "_send_api_key_email accepts admin_login_url; body has <a href>"),

    ("SPEC-1631", "TestSpec1631RemakerDigitalFooterLink", [
        "test_email_wrapper_has_remaker_digital_link",
        "test_email_wrapper_remaker_is_hyperlinked",
    ], "Email footer Remaker Digital hyperlinked", "Footer has <a href='https://remakerdigital.com'>"),

    ("SPEC-0420", "TestSpec0420TeamInvitationEmails", [
        "test_magic_link_request_endpoint_exists",
        "test_send_magic_link_email_function_exists",
    ], "Team invitation emails sent automatically", "Magic link request endpoint for invitations"),

    ("SPEC-0777", "TestSpec0777AutomaticWelcomeEmail", [
        "test_welcome_email_function_is_async",
        "test_welcome_email_called_from_provisioning",
        "test_welcome_email_called_from_stripe",
    ], "Automatic welcome email on tenancy creation", "send_welcome_email called from provisioning and Stripe"),
]
