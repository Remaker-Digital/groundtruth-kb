...
tests_1649 = [
    (
        ...
        "SPEC-1649",
        "A1",
        "Every test in every PLAN-001 phase verifies behavior through live external interfaces",
        "requirement",
    ),
    (
        "TEST-2957",
        "SPEC-1649",
        "A2",
        "No PLAN-001 phase contains mocked API, stub, code inspection, or source-reading tests",
        "requirement",
    ),
    (
        "TEST-2958",
        "SPEC-1649",
        "A3",
        "tests/e2e/ directory is not referenced in any PLAN-001 phase test_ids",
        "requirement",
    ),
    (
        "TEST-2959",
        "SPEC-1649",
        "A4",
        "tests/widget/ directory is not referenced in any PLAN-001 phase test_ids",
        "requirement",
    ),
    (
        "TEST-2960",
        "SPEC-1649",
        "A5",
        "tests/visual/ directory is not referenced in any PLAN-001 phase test_ids",
        "requirement",
    ),
    (
        "TEST-2961",
        "SPEC-1649",
        "A6",
        "tests/ops/ directory is not referenced in any PLAN-001 phase test_ids",
        "requirement",
    ),
    (
        "TEST-2962",
        "SPEC-1649",
        "A7",
        "Phase 2 unit/integration mocked tests are not in any PLAN-001 phase",
        "requirement",
    ),
    (
        "TEST-2963",
        "SPEC-1649",
        "A8",
        "KB assertion checks (source inspection) are not in any PLAN-001 phase",
        "requirement",
    ),
    (
        "TEST-2964",
        "SPEC-1649",
        "A9",
        "All code paths from removed tests have equivalent live interface coverage",
        "requirement",
    ),
]
...
tests_1650 = [
    (
        ...
        "SPEC-1650",
        "A1",
        "tests/e2e/, tests/widget/, tests/visual/, tests/ops/ directories exist in repository",
        "requirement",
    ),
    (
        "TEST-2966",
        "SPEC-1650",
        "A2",
        "tests/multi_tenant/, tests/unit/, tests/agents/, tests/chat/, tests/integrations/ directories exist",
        "requirement",
    ),
    ...
    (
        ...
        "SPEC-1650",
        "A4",
        "Thermal-safe harness can still execute mocked tests for local development",
        "requirement",
    ),
]
...
tests_1651 = [
    (
        ...
        "SPEC-1651",
        "A1",
        "Every admin UI page has at least one live E2E test against staging",
        "requirement",
    ),
    ...
    (
        ...
        "SPEC-1651",
        "A4",
        "New live tests created for code paths previously covered only by mocked tests",
        "requirement",
    ),
