...
tests = [
    ...
    (
        "test_extract_tenant_from_subject_no_dot",
        "TestHelperFunctions",
        "SPEC-1781",
        "Returns None for subject without dot",
    ),
    ...
    (
        "test_half_open_after_recovery_period",
        "TestCircuitBreaker",
        "SPEC-1781",
    ...
    (
        "test_authorize_cross_tenant_raises",
        "TestAuthorization",
        "SPEC-1781",
        "Cross-tenant access raises NATSAuthorizationError",
    ),
    ...
    (
        "test_extract_headers_from_message",
        "TestCorrelationHeaders",
        "SPEC-1781",
        "Extracts correlation from NATS message",
    ),
    ...
    (
        "test_require_transport_noop_in_development",
        "TestFailLoudDispatch",
        "SPEC-1780",
    ...
    (
        "test_require_transport_raises_503_in_production",
        "TestFailLoudDispatch",
        "SPEC-1780",
        "Raises 503 in production",
    ),
    (
        "test_transport_available_returns_false_when_no_transport",
        "TestFailLoudDispatch",
        "SPEC-1780",
        "Returns False when no transport",
    ),
    (
        "test_transport_available_returns_true_when_transport_exists",
        "TestFailLoudDispatch",
        "SPEC-1780",
        "Returns True when transport exists",
    ),
    # TestReadyEndpointEnforcement (2)
    (
        "test_ready_returns_503_in_staging_without_transport",
        "TestReadyEndpointEnforcement",
        "SPEC-1780",
        "/ready returns 503 in staging without transport",
    ),
    (
        "test_ready_returns_200_in_development_without_transport",
        "TestReadyEndpointEnforcement",
        "SPEC-1780",
        "/ready returns 200 in development without transport",
    ),
    # TestSingletonManagement (2)
    (
        "test_get_nats_manager_returns_instance",
        "TestSingletonManagement",
        "SPEC-1781",
        "Singleton returns TenantNATSManager",
    ),
    (
        "test_get_nats_manager_returns_same_instance",
        "TestSingletonManagement",
        "SPEC-1781",
    ...
    (
        "test_provision_professional_stream",
        "TestLiveStreamProvisioning",
        "SPEC-1781",
        "Provisions professional tier stream",
    ),
    ...
    (
        "test_update_nonexistent_provisions",
        "TestLiveStreamProvisioning",
        "SPEC-1781",
        "Update nonexistent provisions new stream",
    ),
    ...
    (
        "test_cross_tenant_subscribe_rejected",
        "TestLivePublishSubscribe",
        "SPEC-1781",
        "Cross-tenant subscribe rejected",
    ),
    ...
    (
        "test_queue_group_competing_consumers",
        "TestLiveQueueGroups",
        "SPEC-1788",
        "Queue group distributes to one subscriber",
    ),
