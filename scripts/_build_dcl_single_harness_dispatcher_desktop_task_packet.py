...
DCL_BODY = (
    ...
    "- Dispatch state path: .gtkb-state/bridge-poller/dispatch-state.json (used by the dispatcher daemon).\n"
    "- Failures log: .gtkb-state/bridge-poller/dispatch-failures.jsonl (used by the dispatcher daemon).\n"
    "\n"
    "Doctor Check:\n"
    "\n"
