"""Legacy file-role helpers awaiting native-context caller reconciliation.

These functions are not a current source of role authority. Roles belong to
immutable native session bindings. The unused Ollama promotion and closure
helpers have been removed; remaining startup/workstream consumers still require
correction before ordinary operation resumes.
"""
