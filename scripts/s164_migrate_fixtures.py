...
MUTATION_CLASSES = {
    "TestInviteForm", "TestRoleChange", "TestEscalationCategories",
    "TestActiveDisabledToggle", "TestDeleteMember", "TestSuperadminProtection",
    "TestSaveConfig", "TestConfigHistory",
    "TestAddArticleModal", "TestDeleteArticle", "TestArticleActions",
    "TestDraftReply", "TestQuickActions",
    "TestCreateAction", "TestEditAction", "TestDeleteAction",
    "TestSaveWidget", "TestDisconnectButton",
    "TestMemoryToggle", "TestRetentionSettings",
    # S164 round 2: Additional mutation classes found during validation
    "TestNegativeInviteForm", "TestConfigActions", "TestConversationActions",
    "TestContactUsButton", "TestEscalationMutations", "TestArticleCRUD",
    "TestMobileLayout",
}
