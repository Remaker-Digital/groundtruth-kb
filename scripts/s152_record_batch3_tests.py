...
TESTS = [
    ("SPEC-0261", "TestSpec0261CosmosDbInitialization", [
    ...
    ("SPEC-0250", "TestSpec0250BackendTierGates", [
    ...
    ("SPEC-0296", "TestSpec0296NoisyNeighborPrevention", [
    ...
    ("SPEC-0157", "TestSpec0157ConfigStatusStates", [
    ...
    ("SPEC-0057", "TestSpec0057FreshTenantZeroConversations", [
    ...
    ("SPEC-0456", "TestSpec0456TenantSeededWithDefaults", [
    ...
    ("SPEC-0482", "TestSpec0482AutomatedProvisioning", [
    ...
    ("SPEC-0096", "TestSpec0096EscalationRouting", [
    ...
    ("SPEC-0097", "TestSpec0097EscalationFilter", [
    ...
    ("SPEC-0249", "TestSpec0249TierBadge", [
    ...
    ("SPEC-0171", "TestSpec0171AddonEntitlements", [
    ...
    ("SPEC-0265", "TestSpec0265StripeIpAllowlist", [
    ...
    ("SPEC-0500", "TestSpec0500CustomerIdentificationMechanisms", [
    ...
    ("SPEC-0154", "TestSpec0154TitanSmtp", [
    ...
    ("SPEC-0491", "TestSpec0491SuperadminNotifications", [
    ...
    ("SPEC-0130", "TestSpec0130DeleteConfiguration", [
    ...
    ("SPEC-0053", "TestSpec0053EnglishOnlyAtLaunch", [
