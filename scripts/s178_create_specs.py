...
def cs(id, title, desc, priority="high", scope="backend", tags=None, assertions=None):
    ...
    try:
        row = kdb._conn.execute(
            "SELECT id FROM specifications WHERE id=? AND version=(SELECT MAX(version) FROM specifications WHERE id=?)",
            (id, id),
        ).fetchone()
        if row:
    ...
    kdb.insert_spec(
        ...
        status="specified",
        changed_by="Claude",
        change_reason="P1 Integration Ecosystem (S178)",
        type="requirement",
        priority=priority,
        scope=scope,
...
cs(
    "SPEC-1761",
    "Integration Plugin Framework - Manifest & Registry",
    priority="critical",
    ...
    assertions=[
        {"type": "glob", "pattern": "src/integrations/registry.py"},
...
cs(
    "SPEC-1762",
    "Integration Framework - Normalized Data Models",
    priority="critical",
...
cs(
    "SPEC-1763",
    "Integration Framework - Adapter Protocol Interfaces",
    priority="critical",
...
cs(
    "SPEC-1764",
    "Integration Framework - Multi-Tenant OAuth Manager",
    priority="critical",
...
cs(
    "SPEC-1765",
    "Integration Framework - Two-Layer Credential Vault",
    priority="critical",
...
cs(
    "SPEC-1766",
    "Integration Framework - Universal Webhook Receiver",
    priority="critical",
...
cs(
    "SPEC-1767",
    "Integration Framework - Polling Scheduler & Cursor Management",
...
cs(
    "SPEC-1768",
    "Integration Framework - Bidirectional Sync with Echo Prevention",
...
cs(
    "SPEC-1769",
    "Integration Framework - Action Executor with HITL Gating",
...
cs(
    "SPEC-1770",
    "Integration Framework - Multi-Source Knowledge Ingestion Pipeline",
...
cs(
    "SPEC-1771",
    "Integration Framework - Admin API Extensions",
...
cs(
    "SPEC-1772",
    "Integration Framework - Admin UI Setup & Dashboard",
    scope="frontend",
...
cs(
    "SPEC-1773",
    "Integration Framework - Cosmos DB Schema Extensions",
    ...
    assertions=[
        {
            ...
            "pattern": "integration_credentials|integration_sync",
        }
    ],
)
...
cs(
    "SPEC-1774",
    "Integration Framework - Adaptive Rate Limiter for External APIs",
    priority="medium",
...
cs(
    "SPEC-1775",
    "Zendesk Integration - Full Helpdesk Adapter",
    priority="critical",
...
cs(
    "SPEC-1776",
    "Slack Integration - Channel Adapter for AI Bot",
...
cs(
    "SPEC-1777",
    "Google Docs Integration - Knowledge Source Adapter",
...
cs(
    "SPEC-1778",
    "Integration Framework - Internal Event Bus",
    priority="medium",
