...
tests = [
    # PCM Layer 4 tests
    {"id": "TEST-2695", "spec_id": "SPEC-1519", "title": "FT API: _call_fine_tuning_api creates Azure OpenAI fine-tuning job", "test_type": "integration"},
    {"id": "TEST-2696", "spec_id": "SPEC-1519", "title": "FT API: _check_job_status_api returns job status from Azure OpenAI", "test_type": "integration"},
    {"id": "TEST-2697", "spec_id": "SPEC-1519", "title": "FT API: Training data uploaded as JSONL before job creation", "test_type": "integration"},
    {"id": "TEST-2698", "spec_id": "SPEC-1520", "title": "FT Eval: _call_model_for_evaluation returns real model output", "test_type": "integration"},
    {"id": "TEST-2699", "spec_id": "SPEC-1521", "title": "FT Persistence: TrainingJobRecord stored in Cosmos DB", "test_type": "integration"},
    {"id": "TEST-2700", "spec_id": "SPEC-1521", "title": "FT Persistence: FineTunedModelRecord stored in Cosmos DB", "test_type": "integration"},
    {"id": "TEST-2701", "spec_id": "SPEC-1522", "title": "FT Admin: POST /api/admin/fine-tuning/trigger returns job_id", "test_type": "e2e"},
    {"id": "TEST-2702", "spec_id": "SPEC-1522", "title": "FT Admin: GET /api/admin/fine-tuning/status returns history", "test_type": "e2e"},
    {"id": "TEST-2703", "spec_id": "SPEC-1522", "title": "FT Admin: Non-Enterprise receives 403", "test_type": "e2e"},
    {"id": "TEST-2704", "spec_id": "SPEC-1523", "title": "FT UI: Enterprise toggle renders on MemoryPrivacy page", "test_type": "e2e"},
    {"id": "TEST-2705", "spec_id": "SPEC-1523", "title": "FT UI: Non-Enterprise sees upgrade prompt", "test_type": "e2e"},
    # AGNTCY/SLIM tests
    {"id": "TEST-2706", "spec_id": "SPEC-1524", "title": "SLIM: Transport connects when endpoint configured", "test_type": "integration"},
    {"id": "TEST-2707", "spec_id": "SPEC-1524", "title": "SLIM: Falls back to NATS when unavailable", "test_type": "integration"},
    {"id": "TEST-2708", "spec_id": "SPEC-1524", "title": "SLIM: Health reports connection status", "test_type": "integration"},
    {"id": "TEST-2709", "spec_id": "SPEC-1525", "title": "A2A: Pipeline routes via transport when configured", "test_type": "integration"},
    {"id": "TEST-2710", "spec_id": "SPEC-1525", "title": "A2A: Messages include correlation headers", "test_type": "integration"},
    {"id": "TEST-2711", "spec_id": "SPEC-1526", "title": "MCP: SDK listed in requirements.txt", "test_type": "unit"},
    # Scale tests
    {"id": "TEST-2712", "spec_id": "SPEC-1527", "title": "Locust: locustfile.py exists and is importable", "test_type": "unit"},
    {"id": "TEST-2713", "spec_id": "SPEC-1527", "title": "Locust: Multi-tenant simulation configurable", "test_type": "performance"},
    {"id": "TEST-2714", "spec_id": "SPEC-1528", "title": "KEDA: Scale-up test on queue depth", "test_type": "performance"},
    {"id": "TEST-2715", "spec_id": "SPEC-1529", "title": "Baseline: Single-tenant P95 measurement", "test_type": "performance"},
    {"id": "TEST-2716", "spec_id": "SPEC-1529", "title": "Baseline: Multi-tenant P95 measurement", "test_type": "performance"},
    # Tracing tests
    {"id": "TEST-2717", "spec_id": "SPEC-1530", "title": "Trace: Conversation document includes trace_id", "test_type": "integration"},
    {"id": "TEST-2718", "spec_id": "SPEC-1530", "title": "Trace: Pipeline agents receive X-Trace-Id header", "test_type": "integration"},
    {"id": "TEST-2719", "spec_id": "SPEC-1531", "title": "Trace: Pipeline trace has per-stage latency", "test_type": "integration"},
    {"id": "TEST-2720", "spec_id": "SPEC-1531", "title": "Trace: Pipeline trace has agent output summaries", "test_type": "integration"},
    {"id": "TEST-2721", "spec_id": "SPEC-1531", "title": "Trace: GET /api/admin/conversations/{id}/trace returns data", "test_type": "e2e"},
    {"id": "TEST-2722", "spec_id": "SPEC-1532", "title": "Trace UI: Inbox shows pipeline stage timeline", "test_type": "e2e"},
    {"id": "TEST-2723", "spec_id": "SPEC-1532", "title": "Trace UI: Stages show latency bars", "test_type": "e2e"},
    {"id": "TEST-2724", "spec_id": "SPEC-1533", "title": "SSE: Events include trace_id in payload", "test_type": "integration"},
    {"id": "TEST-2725", "spec_id": "SPEC-1533", "title": "SSE: Stage events include stage name and elapsed_ms", "test_type": "integration"},
]
