...
fixes = [
    {
        "id": "SPEC-1516",
        "title": "Agent Red near-term scale target: 680 merchant customers",
        ...
        "assertions": [
            {
                ...
                "description": "Load test exercises 680-tenant target",
            },
            {
                "type": "grep",
                "pattern": "680",
                "file": "tests/performance/test_concurrent_tenants.py",
                "description": "Concurrent tenant test targets 680",
            },
            {
                "type": "grep",
                "pattern": "680",
                "file": "tests/performance/test_keda_scaling.py",
                "description": "KEDA scaling test references 680",
            },
        ],
    ...
    {
        "id": "SPEC-1517",
        "title": "MCP and AGNTCY (requiring SLIM transport) are central technical features",
        ...
        "assertions": [
            {
                "type": "grep",
                "pattern": "slim",
                "file": "src/multi_tenant/agntcy_sdk_integration.py",
                "description": "SLIM transport integration exists",
            },
            {
                "type": "grep",
                "pattern": "agntcy",
                "file": "src/multi_tenant/agntcy_sdk_integration.py",
                "description": "AGNTCY SDK integration exists",
            },
        ],
        ...
        "assertions": [
            {
                "type": "grep",
                "pattern": "fine_tun",
                "file": "src/multi_tenant/fine_tuning_pipeline.py",
                "description": "Fine-tuning pipeline module exists",
            },
            {
                "type": "grep",
                "pattern": "openai",
                "file": "src/multi_tenant/fine_tuning_pipeline.py",
                "description": "OpenAI client in pipeline",
            },
            {
                "type": "glob",
                "pattern": "tests/persistent_memory/test_fine_tuning.py",
                "description": "Fine-tuning test file exists",
            },
        ],
        ...
        "assertions": [
            {
                ...
                "pattern": "evaluat",
                "file": "src/multi_tenant/fine_tuning_pipeline.py",
                "description": "Evaluation logic in pipeline",
            },
            {
                "type": "grep",
                "pattern": "fine_tuned_model",
                "file": "src/multi_tenant/fine_tuning_pipeline.py",
        ...
        "assertions": [
            {
                ...
                "pattern": "training",
                "file": "src/multi_tenant/fine_tuning_pipeline.py",
                "description": "Training references in pipeline",
            },
            {
                "type": "grep",
                "pattern": "cosmos",
                "file": "src/multi_tenant/fine_tuning_pipeline.py",
                "description": "Cosmos DB persistence",
            },
        ],
        "tags": ["pcm", "cosmos"],
    },
    {
        ...
        "assertions": [
            {
                "type": "glob",
                "pattern": "src/multi_tenant/admin_fine_tuning_api.py",
                "description": "Fine-tuning admin API module exists",
            },
            {
                "type": "grep",
                "pattern": "fine_tuning",
                "file": "src/multi_tenant/admin_fine_tuning_api.py",
                "description": "Fine-tuning endpoints defined",
            },
            {
                "type": "grep",
                "pattern": "router",
                "file": "src/multi_tenant/admin_fine_tuning_api.py",
                "description": "Router registration",
            },
        ],
        "tags": ["pcm", "admin-api"],
    },
        ...
        "assertions": [
            {
                "type": "grep",
                "pattern": "fine.?tun",
                "file": "admin/standalone/pages/AgentConfig.tsx",
                "description": "Fine-tuning controls in admin UI",
            },
        ],
        "tags": ["pcm", "admin-ui"],
    },
    {
        ...
        "assertions": [
            {
                "type": "grep",
                "pattern": "SLIM_ENDPOINT",
                "file": "src/multi_tenant/agntcy_sdk_integration.py",
                "description": "SLIM endpoint config",
            },
            {
                "type": "grep",
                "pattern": "nats",
        ...
        "assertions": [
            {
                ...
                "pattern": "X-Trace-Id",
                "file": "src/multi_tenant/agntcy_sdk_integration.py",
                "description": "Trace ID in SLIM transport",
            },
            {
                "type": "grep",
                "pattern": "dispatch",
                "file": "src/multi_tenant/agntcy_sdk_integration.py",
                "description": "Message dispatch function",
            },
        ],
        "tags": ["slim", "a2a"],
    },
    ...
    },
    {
        ...
        "assertions": [
            {"type": "glob", "pattern": "tests/performance/locustfile.py", "description": "Locust test file exists"},
            {
                ...
                "pattern": "HttpUser",
                "file": "tests/performance/locustfile.py",
                "description": "Locust HttpUser class",
            },
        ],
    ...
    },
    {
        ...
        "assertions": [
            {
                "type": "glob",
                "pattern": "tests/performance/test_keda_scaling.py",
                "description": "KEDA test file exists",
            },
            {
                "type": "grep",
                "pattern": "keda",
                "file": "tests/performance/test_keda_scaling.py",
                "description": "KEDA references in test",
            },
        ],
        "tags": ["keda", "scaling"],
    },
    {
        ...
        "assertions": [
            {
                "type": "glob",
                "pattern": "tests/performance/test_concurrent_tenants.py",
                "description": "Concurrent tenant test file exists",
            },
            {
                "type": "grep",
                "pattern": "concurrent",
                "file": "tests/performance/test_concurrent_tenants.py",
                "description": "Concurrent test patterns",
            },
        ],
    ...
    },
    {
        ...
        "status": "implemented",
        "section": "CHAT_PIPELINE",
        "assertions": [
            {
                "type": "grep",
                "pattern": "trace_id",
                "file": "src/chat/endpoints.py",
                "description": "trace_id generated at endpoint",
            },
            {
                "type": "grep",
                "pattern": "X-Trace-Id",
                "file": "src/chat/endpoints.py",
                "description": "X-Trace-Id header in response",
            },
            {
                "type": "grep",
                "pattern": "trace_id",
                "file": "src/chat/pipeline/orchestrator.py",
                "description": "trace_id propagated through orchestrator",
            },
        ],
    ...
    },
    {
        ...
        "assertions": [
            {
                "type": "grep",
                "pattern": "pipeline_trace",
                "file": "src/multi_tenant/cosmos_schema.py",
                "description": "pipeline_trace in Cosmos schema",
            },
            {
                "type": "grep",
                "pattern": "stage_event",
                "file": "src/chat/models.py",
                "description": "stage_event method in models",
            },
            {
                "type": "grep",
                "pattern": "elapsed_ms",
                "file": "src/chat/models.py",
                "description": "elapsed_ms tracking",
            },
        ],
    ...
    },
    {
        ...
        "assertions": [
            {
                "type": "grep",
                "pattern": "PipelineTracePanel",
                "file": "admin/standalone/pages/Inbox.tsx",
                "description": "Trace panel in standalone inbox",
            },
            {
                "type": "grep",
                "pattern": "PipelineTracePanel",
                "file": "admin/shared/ConversationInbox.tsx",
                "description": "Trace panel in shared inbox",
            },
            {
                "type": "grep",
                "pattern": "useConversationTrace",
                "file": "admin/shared/hooks/useInbox.ts",
                "description": "Trace hook in shared hooks",
            },
        ],
        ...
        "assertions": [
            {
                ...
                "pattern": "trace_id",
                "file": "src/chat/models.py",
                "description": "trace_id in SSE event models",
            },
            {
                "type": "grep",
                "pattern": "done_event",
                "file": "src/chat/models.py",
                "description": "done_event with trace metadata",
            },
        ],
        "tags": ["tracing", "sse"],
    },
