...
tests = [
    (
        "TEST-2654",
        "SPEC-0298",
        "Storefront name on Dashboard",
        "unit",
        "PASS",
        "tests/widget/test_admin_features_batch.py",
        "TestStorefrontNameDashboard",
    ),
    (
        "TEST-2655",
        "SPEC-0135",
        "Escalation agent role rename",
        "unit",
        "PASS",
        "tests/widget/test_admin_features_batch.py",
        "TestEscalationAgentRole",
    ),
    (
        "TEST-2656",
        "SPEC-0298",
        ...
        "PASS",
        "tests/widget/test_admin_features_batch.py",
        "TestSideBySideColorPickers",
    ),
    (
        "TEST-2657",
        "SPEC-0298",
        "Page assignments list layout",
        "unit",
        "PASS",
        "tests/widget/test_admin_features_batch.py",
        "TestPageAssignmentsList",
    ),
    (
        "TEST-2658",
        "SPEC-0298",
    ...
    (
        ...
        "PASS",
        "tests/widget/test_admin_features_batch.py",
        "TestQuickActionsStarterExamples",
    ),
    (
        "TEST-2662",
        "SPEC-0298",
        "Quick action icon guidance",
        "unit",
        "PASS",
        "tests/widget/test_admin_features_batch.py",
        "TestQuickActionIconGuidance",
    ),
    (
        "TEST-2663",
        "SPEC-0298",
        "Named config save/restore",
        "unit",
        "PASS",
        "tests/widget/test_admin_features_batch.py",
        "TestNamedConfigSaveRestore",
    ),
    (
        "TEST-2664",
        "SPEC-0298",
        "Escalation category assignment",
        "unit",
        "PASS",
        "tests/widget/test_admin_features_batch.py",
        "TestEscalationCategoryAssignment",
    ),
    (
        "TEST-2665",
        "SPEC-0298",
        ...
        "PASS",
        "tests/widget/test_admin_features_batch.py",
        "TestLauncherPositionOffset",
    ),
    (
        "TEST-2666",
        "SPEC-0298",
        "Widget drop-shadow control",
        "unit",
        "PASS",
        "tests/widget/test_admin_features_batch.py",
        "TestWidgetDropShadow",
    ),
    (
        "TEST-2667",
        "SPEC-0298",
        "Launcher icon and avatar customization",
        "unit",
        "PASS",
        "tests/widget/test_admin_features_batch.py",
        "TestLauncherIconAndAvatar",
    ),
    (
        "TEST-2668",
        "SPEC-0298",
        "Chat UI draggable repositionable",
        "unit",
        "PASS",
        "tests/widget/test_admin_features_batch.py",
        "TestChatDraggable",
    ...
    (
        "TEST-2669",
        "SPEC-0298",
        "Auto-open per page via Quick Actions",
        "unit",
        "PASS",
        "tests/widget/test_admin_features_batch.py",
        "TestAutoOpenPerPage",
    ...
    (
        ...
        "PASS",
        "tests/widget/test_admin_features_batch.py",
        "TestChatScrollControls",
    ),
    (
        "TEST-2672",
        "SPEC-0298",
        "Wizard test mode toggle",
        "unit",
        "PASS",
        "tests/widget/test_admin_features_batch.py",
        "TestWizardTestModeToggle",
    ),
    (
        "TEST-2673",
        "SPEC-0298",
        "Memory and privacy sidebar page",
        "unit",
        "PASS",
        "tests/widget/test_admin_features_batch.py",
        "TestMemoryPrivacyPage",
    ),
]
...
done_wis = [
    (
        "WI-0779",
        "Display storefront name prominently on Dashboard",
        "customer_interface",
        "SPEC-0298",
    ...
    (
        "WI-0784",
        "Rename Agent role to Escalation agent",
        "customer_interface",
        "SPEC-0135",
    ...
    (
        "WI-0788",
        "Page assignments single-column list instead of dropdown",
        "customer_interface",
        "SPEC-0298",
    ...
    (
        "WI-0789",
        "Template variables inline below prompt input",
        "customer_interface",
        "SPEC-0298",
    ...
    (
        "WI-0790",
        "Role selector out of Actions column",
        "customer_interface",
        "SPEC-0135",
    ...
    (
        "WI-0793",
        "Widget does not display custom greeting message",
        "customer_interface",
        "SPEC-0529",
    ...
    (
        "WI-0794",
        "Quick actions page: starter examples on first visit",
        "customer_interface",
        "SPEC-0298",
    ...
    (
        "WI-0795",
        "Quick action Icon field: format guidance",
        "customer_interface",
        "SPEC-0298",
    ...
    (
        "WI-0799",
        "Named configuration save/restore",
        "customer_interface",
        "SPEC-0298",
    ...
    (
        "WI-0805",
        "Launcher position offset controls",
        "customer_interface",
        "SPEC-0298",
    ...
    (
        "WI-0807",
        "Widget launcher icon and agent avatar customization",
        "customer_interface",
        "SPEC-0298",
    ...
    (
        "WI-0810",
        "Auto-open per page via Quick Actions config",
        "customer_interface",
        "SPEC-0298",
    ...
    (
        "WI-0811",
        "Chat input area height: 3 text lines default",
        "customer_interface",
        "SPEC-0298",
    ...
    (
        "WI-0812",
        "Chat display area scroll controls",
        "customer_interface",
        "SPEC-0298",
    ...
    (
        "WI-0821",
        "Wizard mode selector: Standard / Test toggle",
        "customer_interface",
        "SPEC-0298",
    ...
    (
        "WI-0823",
        "New sidebar page: Memory and privacy",
        "customer_interface",
        "SPEC-0298",
