...
SPEC_BODY = (
    ...
    "Applicability:\n"
    "\n"
    "The single-harness bridge dispatcher is active iff harness-state/role-assignments.json records a single "
    "harness ID whose role-set has cardinality >= 2 (i.e., the single harness holds both prime-builder and "
