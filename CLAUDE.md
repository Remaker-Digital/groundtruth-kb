...
|---------------|------|-------|---------|--------|---------|
| agent-red-api-gateway | 8000 | api-gateway:v1.6.0 | 2/8 | Succeeded | External HTTP (FQDN: `agent-red-api-gateway.lemonriver-f59f94b7.eastus2.azurecontainerapps.io`) |
