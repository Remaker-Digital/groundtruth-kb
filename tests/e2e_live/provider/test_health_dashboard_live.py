...
class TestProviderHeader:
    ...
    def test_logo_present(self, live_health_dashboard_page: Page):
        """Header contains the Agent Red logo image."""
        logo = live_health_dashboard_page.locator("header img[src*='logo']")
        assert logo.count() > 0, "Provider console header must contain logo image"

    def test_console_title(self, live_health_dashboard_page: Page):
        """Header shows 'Service Provider Console' title."""
        header = live_health_dashboard_page.locator("header")
    ...
    def test_version_badge(self, live_health_dashboard_page: Page):
    ...
    def test_docs_link(self, live_health_dashboard_page: Page):
        """Header has documentation link pointing to agentredcx.com."""
        docs_btn = live_health_dashboard_page.locator(
    ...
    def test_docs_link_aria_label(self, live_health_dashboard_page: Page):
    ...
    def test_logout_button(self, live_health_dashboard_page: Page):
        """Header has sign-out button with aria-label."""
        logout_btn = live_health_dashboard_page.locator(
    ...
    def test_burger_menu_hidden_desktop(self, live_health_dashboard_page: Page):
        """Burger menu is hidden on desktop viewport (hiddenFrom='sm')."""
        burger = live_health_dashboard_page.locator("header button[class*='burger' i]")
        if burger.count() > 0:
...
class TestProviderSidebar:
    ...
    def test_nav_group_labels(self, live_health_dashboard_page: Page):
        """All 4 navigation group labels are present."""
        nav = live_health_dashboard_page.locator("nav")
    ...
    def test_nav_item_present(self, live_health_dashboard_page: Page, nav_label: str, path: str):
    ...
    def test_nav_item_descriptions(self, live_health_dashboard_page: Page):
    ...
    def test_nav_item_icons(self, live_health_dashboard_page: Page):
    ...
    def test_dashboard_active_by_default(self, live_health_dashboard_page: Page):
    ...
    def test_group_dividers(self, live_health_dashboard_page: Page):
    ...
    def test_scroll_area(self, live_health_dashboard_page: Page):
...
class TestProviderNavigation:
    ...
    def test_navigate_to_tenants(self, live_health_dashboard_page: Page):
        """Clicking 'Tenants' navigates to tenant directory."""
        page = live_health_dashboard_page
    ...
    def test_navigate_to_deployments(self, live_health_dashboard_page: Page):
    ...
    def test_navigate_and_return(self, live_health_dashboard_page: Page):
...
class TestDashboardHeader:
    ...
    def test_page_title(self, live_health_dashboard_page: Page):
        """Page shows 'Platform Dashboard' title."""
        text = _main_text(live_health_dashboard_page)
        assert "platform dashboard" in text.lower(), (
            f"Page must show 'Platform Dashboard' title, got: {text[:200]}"
        )

    def test_help_tooltip_icon(self, live_health_dashboard_page: Page):
        """Page header has HelpTooltip (circled '?' icon)."""
        tooltip = live_health_dashboard_page.locator(
        ...
        if tooltip.count() > 0:
            ...
            q_marks = live_health_dashboard_page.locator("main >> text=?")
            assert q_marks.count() > 0, "Page must have HelpTooltip '?' icon"

    def test_timestamp_display(self, live_health_dashboard_page: Page):
    ...
    def test_timestamp_format(self, live_health_dashboard_page: Page):
...
class TestSystemHealthCards:
    ...
    def test_four_health_cards(self, live_health_dashboard_page: Page):
        """Dashboard renders exactly 4 system health cards."""
        if _is_rate_limited(live_health_dashboard_page):
            pytest.skip("Rate limited — cannot verify health cards")
        cards = live_health_dashboard_page.locator(
    ...
    def test_nats_card(self, live_health_dashboard_page: Page):
        """NATS health card is present."""
        if _is_rate_limited(live_health_dashboard_page):
            pytest.skip("Rate limited — cannot verify NATS card")
        text = _main_text(live_health_dashboard_page).lower()
        assert "nats" in text, "Dashboard must show NATS health card"

    def test_nats_status_detail(self, live_health_dashboard_page: Page):
    ...
    def test_key_vault_card(self, live_health_dashboard_page: Page):
    ...
    def test_key_vault_status(self, live_health_dashboard_page: Page):
    ...
    def test_api_version_card(self, live_health_dashboard_page: Page):
    ...
    def test_circuit_breakers_card(self, live_health_dashboard_page: Page):
    ...
    def test_circuit_breakers_status(self, live_health_dashboard_page: Page):
    ...
    def test_health_card_labels_uppercase(self, live_health_dashboard_page: Page):
...
class TestTenantDistribution:
    ...
    def test_section_title(self, live_health_dashboard_page: Page):
    ...
    def test_total_tenants_card(self, live_health_dashboard_page: Page):
    ...
    def test_total_tenants_numeric(self, live_health_dashboard_page: Page):
    ...
    def test_by_status_card(self, live_health_dashboard_page: Page):
    ...
    def test_by_status_badges(self, live_health_dashboard_page: Page):
    ...
    def test_by_tier_card(self, live_health_dashboard_page: Page):
    ...
    def test_by_tier_badges(self, live_health_dashboard_page: Page):
    ...
    def test_three_distribution_cards(self, live_health_dashboard_page: Page):
...
class TestRecentDeployments:
    ...
    def test_deployment_event_badges(self, live_health_dashboard_page: Page):
    ...
    def test_deployment_actor(self, live_health_dashboard_page: Page):
    ...
    def test_deployment_timestamp(self, live_health_dashboard_page: Page):
    ...
    def test_deployments_in_paper_container(self, live_health_dashboard_page: Page):
        ...
        papers = live_health_dashboard_page.locator(
...
class TestDashboardStates:
    ...
    def test_no_loading_spinner_after_load(self, live_health_dashboard_page: Page):
    ...
    def test_error_state_content(self, live_health_dashboard_page: Page):
    ...
    def test_dashboard_has_content(self, live_health_dashboard_page: Page):
...
class TestDashboardGrid:
    ...
    def test_health_cards_grid(self, live_health_dashboard_page: Page):
        ...
        grids = live_health_dashboard_page.locator(
    ...
    def test_distribution_cards_grid(self, live_health_dashboard_page: Page):
        ...
        cols = live_health_dashboard_page.locator(
