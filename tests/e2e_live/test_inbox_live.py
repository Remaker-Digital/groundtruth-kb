...
class TestSearchAndFilters:
    ...
    def test_search_input_exists(self, shared_inbox_page: Page):
        """[EL-inbox-001/A1] Search input is visible on the page."""
        search = shared_inbox_page.locator(
    ...
    def test_search_placeholder(self, shared_inbox_page: Page):
    ...
    # C1: Search has icon
    def test_search_has_icon(self, shared_inbox_page: Page):
        """[EL-inbox-001/C1] Search input has a search/magnifying glass icon."""
        search_area = shared_inbox_page.locator(
            "[class*='search' i], "
            "input[placeholder*='Search' i]"
        ).first
    ...
    def test_filter_tabs_exist(self, shared_inbox_page: Page):
    ...
    def test_all_tab_with_count(self, shared_inbox_page: Page):
    ...
    # B1: Active tab
    def test_active_tab_exists(self, shared_inbox_page: Page):
    ...
    # B1: Esc tab
    def test_escalated_tab_exists(self, shared_inbox_page: Page):
    ...
    # B1: Resolved tab
    def test_resolved_tab_exists(self, shared_inbox_page: Page):
    ...
    def test_click_active_filter_tab(self, shared_inbox_page: Page):
    ...
    def test_click_escalated_filter_tab(self, shared_inbox_page: Page):
    ...
    def test_click_resolved_filter_tab(self, shared_inbox_page: Page):
    ...
    def test_click_archived_filter_tab(self, shared_inbox_page: Page):
    ...
    def test_click_all_filter_restores_full_list(self, shared_inbox_page: Page):
    ...
    def test_search_filters_conversations(self, shared_inbox_page: Page):
        ...
        shared_inbox_page.wait_for_timeout(2000)  # 350ms debounce + API round-trip
        ...
        search.first.fill("")
        shared_inbox_page.wait_for_timeout(2000)

    # E1: Search with gibberish shows empty state
    def test_search_no_results_shows_empty_state(self, shared_inbox_page: Page):
        ...
        pre_text = _text(shared_inbox_page)
...
class TestConversationListItems:
    ...
    def test_conversation_items_exist(self, shared_inbox_page: Page):
    ...
    def test_customer_name_shown(self, shared_inbox_page: Page):
    ...
    # B1: Time ago text
    def test_time_ago_shown(self, shared_inbox_page: Page):
    ...
    def test_message_count_shown(self, shared_inbox_page: Page):
    ...
    def test_status_badges_present(self, shared_inbox_page: Page):
    ...
    def test_click_conversation_selects_it(self, shared_inbox_page: Page):
        """[EL-inbox-008/E1] Clicking a conversation populates detail panel."""
        if _is_rate_limited(shared_inbox_page):
            pytest.skip("Rate-limited by API")
        if not _select_first_conversation(shared_inbox_page):
    ...
    def test_avatars_exist(self, shared_inbox_page: Page):
        """[EL-inbox-009/C1] Avatar circles are rendered in conversation list."""
        avatars = shared_inbox_page.locator(
            "[class*='Avatar' i], "
            "[class*='avatar' i], "
...
class TestThreadHeader:
    ...
    def _select_conversation(self, shared_inbox_page: Page):
        """Select the first conversation to show the thread view."""
        if not _select_first_conversation(shared_inbox_page):
            pytest.skip("No selectable conversations on staging tenant")

    # A1: Thread header shows customer name
    def test_thread_header_name(self, shared_inbox_page: Page):
    ...
    def test_thread_status_badge(self, shared_inbox_page: Page):
    ...
    def test_thread_message_count(self, shared_inbox_page: Page):
    ...
    def test_action_buttons_visible(self, shared_inbox_page: Page):
        ...
        action_svgs = shared_inbox_page.locator(
...
class TestMessageBubbles:
    ...
    def test_customer_messages_visible(self, shared_inbox_page: Page):
    ...
    def test_ai_messages_visible(self, shared_inbox_page: Page):
    ...
    def test_message_role_labels(self, shared_inbox_page: Page):
    ...
    def test_message_timestamps(self, shared_inbox_page: Page):
    ...
    def test_scroll_area_exists(self, shared_inbox_page: Page):
        """[EL-inbox-032/A1] Message thread scroll area is present."""
        scroll = shared_inbox_page.locator(
            "[class*='scroll' i], "
            "[class*='ScrollArea'], "
            "[style*='overflow']"
        )
        assert scroll.count() > 0 or _count(shared_inbox_page, "main") > 0, (
...
class TestCustomerDetails:
    ...
    def test_detail_avatar_exists(self, shared_inbox_page: Page):
    ...
    def test_conversation_info_section(self, shared_inbox_page: Page):
    ...
    def test_detail_messages_count(self, shared_inbox_page: Page):
    ...
    # B1: Started date
    def test_detail_started_date(self, shared_inbox_page: Page):
        """[EL-inbox-038/B1] 'Started' date field shown in detail panel."""
        text = _text(shared_inbox_page)
        assert "started" in text.lower(), "'Started' date field not found"

    # B1: Last activity
    def test_detail_last_activity(self, shared_inbox_page: Page):
    ...
    def test_customer_profile_section(self, shared_inbox_page: Page):
    ...
    def test_verified_or_anonymous_badge(self, shared_inbox_page: Page):
    ...
    # B1: Identity message
    def test_customer_identity_message(self, shared_inbox_page: Page):
    ...
    def test_detail_status_badge(self, shared_inbox_page: Page):
...
class TestPipelineTrace:
    ...
    def test_pipeline_trace_section_exists(self, shared_inbox_page: Page):
    ...
    def test_trace_intent_or_no_trace(self, shared_inbox_page: Page):
    ...
    def test_trace_critic_badge(self, shared_inbox_page: Page):
    ...
    def test_trace_latency(self, shared_inbox_page: Page):
    ...
    def test_trace_stage_bars(self, shared_inbox_page: Page):
        ...
        bars = shared_inbox_page.locator("[style*='background'], [class*='bar' i]")
...
class TestEscalationModal:
    ...
    def test_escalate_button_exists(self, shared_inbox_page: Page):
    ...
    def test_escalate_opens_modal(self, shared_inbox_page: Page):
        ...
        modal_text = _text(shared_inbox_page)
        ...
        cancel_btn = shared_inbox_page.locator("button:has-text('Cancel')")
        if cancel_btn.count() > 0:
            cancel_btn.first.click()
            shared_inbox_page.wait_for_timeout(500)

    # E1: Escalation modal has category dropdown
    def test_escalation_modal_category_dropdown(self, shared_inbox_page: Page):
        ...
        has_select = shared_inbox_page.locator(
    ...
    def test_escalation_modal_cancel(self, shared_inbox_page: Page):
        ...
        assert "escalate to human" in _text(shared_inbox_page).lower() or \
               "category" in _text(shared_inbox_page).lower(), "Modal did not open"
...
class TestEmptyAndLoadingStates:
    ...
    def test_no_lingering_spinners(self, shared_inbox_page: Page):
        """[EL-inbox-058/I1] No loading spinners stuck on page."""
        spinners = shared_inbox_page.locator(
    ...
    def test_conversations_or_empty_state(self, shared_inbox_page: Page):
    ...
    def test_select_conversation_prompt(self, shared_inbox_page: Page):
...
class TestLayoutStructure:
    ...
    def test_three_panel_layout(self, shared_inbox_page: Page):
        """[EL-inbox-065..067/A1] Page has a 3-panel layout structure."""
        panels = shared_inbox_page.locator(
            "[style*='border-right'], "
            "[style*='borderRight'], "
            "[style*='border-left'], "
            "[style*='borderLeft'], "
        ...
        flex_containers = shared_inbox_page.locator(
    ...
    def test_left_panel_width(self, shared_inbox_page: Page):
        """[EL-inbox-065/C1] Left panel has a fixed width around 320px."""
        result = shared_inbox_page.evaluate("""() => {
    ...
    def test_right_panel_width(self, shared_inbox_page: Page):
...
class TestSearchResults:
    ...
    def test_search_input_accepts_text(self, shared_inbox_page: Page):
...
class TestInboxIntegrity:
    ...
    def test_page_title_is_inbox(self, shared_inbox_page: Page):
        """[EL-inbox/CROSS] Page title contains 'Inbox'."""
        text = _text(shared_inbox_page)
        assert "inbox" in text.lower(), "Page title 'Inbox' not found"

    def test_no_error_text(self, shared_inbox_page: Page):
        ...
        if "failed to load" in text.lower():
            assert _is_rate_limited(shared_inbox_page), (
                "Non-rate-limit 'failed to load' error visible on inbox"
            )

    def test_data_populated(self, shared_inbox_page: Page):
    ...
    def test_filter_counts_non_negative(self, shared_inbox_page: Page):
    ...
    def test_filter_counts_consistent(self, shared_inbox_page: Page):
    ...
    def test_no_duplicate_conversations(self, shared_inbox_page: Page):
    ...
    def test_all_sections_in_selected_view(self, shared_inbox_page: Page):
