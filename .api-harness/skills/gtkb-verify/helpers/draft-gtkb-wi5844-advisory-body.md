...
`.api-harness/rules/file-bridge-protocol.md` and `.api-harness/rules/operating-role.md`.
...
`.api-harness/rules/peer-solution-advisory-loop.md`, this section is mandatory
...
files (separate gates per `.api-harness/rules/file-bridge-protocol.md`), and re-run
