...
1. **Authorization record verified real and on-point.**
   ...
   `.api-harness/rules/deliberation-protocol.md` ("Owner Decisions" archival).
...
4. **Technical design re-verified against current source (not trusted from
   002's transcript).** Read `.api-harness/hooks/narrative-artifact-approval-gate.py`
...
2026-06-27 despite the hooks remaining registered in `.api-harness/settings.json`
...
- Read in full: `bridge/gtkb-narrative-gate-edit-autodiscovery-fix-001.md`,
  `-002.md`, `-003.md`.
- Read fresh: `.api-harness/hooks/narrative-artifact-approval-gate.py` (grep for
