...
`.api-harness/rules/file-bridge-protocol.md` § "Mandatory Applicability Preflight
...
10. Confirmed direct `Write`/Bash mutation of `bridge/<slug>-NNN.md` is now
    ...
    precedent pattern in `.api-harness/skills/verify/helpers/file_no_go_verdict_wi5445.py`.
