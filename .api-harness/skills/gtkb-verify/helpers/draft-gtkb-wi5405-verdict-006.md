...
in `.api-harness/skills/verify/helpers/write_verdict.py`, then directly invoked both
...
mutable, cross-session-shared `.api-harness/session/envelope.json`, which was
