...
3. **Role rule files are behavior contracts only** - Edits to `.api-harness/rules/operating-role.md` and `.api-harness/rules/prime-builder-role.md` must be limited to clarifying the interaction between interactive session role and dispatcher/default role. They must not attempt to store or override role assignments.
...
- `.api-harness/rules/operating-role.md`
- `.api-harness/rules/prime-builder-role.md`
