...
cap in `.harness-baseline-configuration/hooks/assertion-check.py`. When the retention cap is widened
...
One assertion per call per `.harness-baseline-configuration/rules/codex-way-of-working.md`
...
`.harness-baseline-configuration/hooks/assertion-check.py` reads the latest run summary and surfaces
...
- `DCL-CONCEPT-ON-CONTACT-001` — load-bearing concepts have canonical glossary entries; see `.harness-baseline-configuration/rules/canonical-terminology.md`.
...
Generated at: content-addressed 71ac72d4c030
Canonical source: .harness-baseline-configuration/skills/gtkb-assertion-triage/SKILL.md
Canonical source sha256: 71ac72d4c030e9c5ff6ae42e32f0908a85c7878cadfcd713e8cf122e24483f85
