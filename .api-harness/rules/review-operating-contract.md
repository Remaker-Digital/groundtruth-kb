...
- See `.api-harness/rules/deliberation-protocol.md` for full protocol.
...
1. `AGENTS.md`
2. `.api-harness/rules/file-bridge-protocol.md`
3. `.api-harness/rules/canonical-terminology.md`
4. Bridge status plus the status-bearing numbered bridge file chain
5. `.api-harness/rules/way-of-working.md`
6. `.api-harness/rules/review-operating-contract.md`
7. `.api-harness/rules/loyal-opposition-runbook.md`
8. `.api-harness/rules/knowledge-base-index.md`
