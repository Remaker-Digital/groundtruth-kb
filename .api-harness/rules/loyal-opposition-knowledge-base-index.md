...
## Active Rules under `.api-harness/rules/`
...
- `.api-harness/rules/canonical-terminology.md` — core primer subset only at startup;
  full corpus and activity-specific terms load on `::open <activity>`.
- `.api-harness/rules/file-bridge-protocol.md` — bridge statuses, gates, claim/preflight.
...
`.api-harness/skills/` adapters are generated from the canonical baseline skill source; no separate adapter
