...
the canonical operating-model artifact at `.api-harness/rules/operating-model.md` §1
...
Per Sub-slice C of GTKB-GOV-AUQ-ENFORCEMENT-STACK and `.api-harness/rules/file-bridge-protocol.md` "Mandatory Owner Decisions / Input Section Gate":
