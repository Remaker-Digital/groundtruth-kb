...
- The active Prime Builder / Loyal Opposition bridge is bridge
  state, with `.api-harness/rules/file-bridge-protocol.md` retained for legacy helper
...
- Load `.api-harness/rules/groundtruth-kb-vision.md` as persistent context for GroundTruth-related reviews and proposals.
