...
surface gap called out in .api-harness/rules/bridge-essential.md. Dispatchable bridge
...
- Specific AskUserQuestion approval S341 (2026-05-11): "Approve adding a new
  ...
  bridge surfacing)?" → "Approve" (satisfies .api-harness/rules/bridge-essential.md
