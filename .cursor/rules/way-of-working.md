...
- Credential lifecycle is outside the active harness's scope. Never ask Mike to rotate keys or
  credentials. When credentials change, Mike will update `env.local`; the active harness may
