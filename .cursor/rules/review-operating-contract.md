...
- See `.cursor/rules/deliberation-protocol.md` for full protocol.
...
1. `AGENTS.md`
2. `.cursor/rules/file-bridge-protocol.md`
3. `.cursor/rules/canonical-terminology.md`
4. Bridge status plus the status-bearing numbered bridge file chain
5. `.cursor/rules/way-of-working.md`
6. `.cursor/rules/review-operating-contract.md`
7. `.cursor/rules/loyal-opposition-runbook.md`
8. `.cursor/rules/knowledge-base-index.md`
