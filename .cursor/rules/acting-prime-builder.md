...
(refresh deliberation) establish the current state: harness configuration files ARE a live Codex interception boundary on Windows for
...
relying on harness hooks configuration as a live interception boundary, and must use
