"""One-off governed-writer wrapper: file the WI-5343 NO-GO verdict (version 006).
...
DOCUMENT_NAME = "gtkb-wi5343-lo-review-authority-packet"
VERSION = 6
BODY_PATH = ROOT / ".claude" / "skills" / "verify" / "helpers" / "draft-gtkb-wi5343-006-body.md"
