...
7. Before writing the verdict, run
   `python .codex/skills/gtkb-verify/helpers/write_verdict.py --slug <slug> --body-file <draft-body-file>`
...
11. For a positive `VERIFIED` verdict, run the reviewed final body through the
    ...
    ```text
    python .codex/skills/gtkb-verify/helpers/write_verdict.py --slug <slug> --body-file <reviewed-verdict-body> --finalize-verified --no-prepopulate --commit-message "<type(scope): message>" --include <verified-path> [--include <verified-path> ...]
    ```
