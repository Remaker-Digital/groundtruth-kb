...
1. Read `independent-progress-assments/CODEX-WAY-OF-WORKING.md`.
2. Read `independent-progress-assments/CODEX-LOYAL-OPPOSITION-RUNBOOK.md`.
3. Read `independent-progress-assments/CODEX-KNOWLEDGE-BASE-INDEX.md`.
4. Review the latest file in `independent-progress-assments/CODEX-INSIGHT-DROPBOX/`.
5. Check open items in `independent-progress-assments/LOYAL-OPPOSITION-LOG.md`.
