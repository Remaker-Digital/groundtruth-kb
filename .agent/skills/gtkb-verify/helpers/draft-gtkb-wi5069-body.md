...
- Target paths remain bridge-gated: `groundtruth-kb/src/groundtruth_kb/mode_switch/invariants.py`, `transaction.py`, `derive.py`, plus `.claude/rules/operating-role.md`, `.claude/rules/prime-builder-role.md`, and focused platform tests.
...
5. Update `.claude/rules/operating-role.md` and `.claude/rules/prime-builder-role.md` to describe the lane-coverage invariant and the interactive PB anchor rule.
