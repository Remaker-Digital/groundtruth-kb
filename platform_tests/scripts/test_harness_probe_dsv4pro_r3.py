"""Unit tests for harness_probe_dsv4pro_r3.py — DeepSeek V4 Pro Run 3.
...
# ---------------------------------------------------------------------------
_PROBE_SCRIPT = Path(__file__).resolve().parent.parent.parent / "scripts" / "harness_probe_dsv4pro_r3.py"
...
class TestProjectRootContainment:
    ...
    def test_project_root_containment_fail(self) -> None:
        ...
        from scripts.harness_probe_dsv4pro_r3 import _check_project_root_containment
...
class TestVenvResolution:
    ...
    def test_venv_resolution_fail_returns_false(self) -> None:
        ...
        from scripts.harness_probe_dsv4pro_r3 import _check_venv_resolution
...
class TestGitReadHealth:
    ...
    def test_git_read_health_fail_non_git_dir(self) -> None:
        ...
        from scripts.harness_probe_dsv4pro_r3 import _check_git_read_health
...
class TestGtCliReachability:
    ...
    def test_gt_cli_reachability_fail_nonexistent(self) -> None:
        ...
        from scripts.harness_probe_dsv4pro_r3 import _check_gt_cli_reachability
        ...
        try:
            ...
            with mock.patch("scripts.harness_probe_dsv4pro_r3.subprocess.run") as mock_run:
...
class TestSessionEnvelopePresence:
    ...
    def test_session_envelope_presence_fail_missing(self) -> None:
        ...
        from scripts.harness_probe_dsv4pro_r3 import _check_session_envelope_presence
...
class TestReportStructure:
    ...
    def test_run_identifier_is_r3(self) -> None:
        """run_identifier matches the run-3 designation."""
        report = _run_probe_json()
        assert report["run_identifier"] == "dsv4pro-r3", f"Expected dsv4pro-r3, got {report['run_identifier']}"
