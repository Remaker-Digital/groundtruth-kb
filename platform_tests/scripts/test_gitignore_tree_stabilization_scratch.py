...
IGNORED_SCRATCH_PATHS = (
    ...
    ".claude/skills/gtkb-verify/helpers/_temp_verdict_example.md",
    ".claude/skills/gtkb-verify/helpers/example-draft-body.md",
    ".codex/skills/gtkb-verify/helpers/_tmp_example.md",
    ".codex/skills/gtkb-verify/helpers/draft-example.md",
    ".codex/skills/gtkb-verify/helpers/writer_script.py",
...
WI5299_IGNORED_SCRATCH_PATHS = (
    ...
    ".claude/skills/gtkb-verify/helpers/draft_wi5299.md",
    ".claude/skills/gtkb-verify/helpers/writer_script.py",
    ".codex/skills/gtkb-verify/helpers/tmp_gtkb-wi5061-draft.md",
