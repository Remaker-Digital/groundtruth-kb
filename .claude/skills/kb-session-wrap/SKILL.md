...
- `bridge/INDEX.md` for latest statuses and any GO/NO-GO/NEW/VERIFIED changes created this session.
...
| Bridge state | `bridge/INDEX.md` and versioned bridge files | Ensure proposals, reports, GO/NO-GO, and VERIFIED entries are current and latest-status accurate. |
