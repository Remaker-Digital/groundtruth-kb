...
- `bridge/INDEX.md` (only when bridge hygiene or bridge actionability is in scope)
...
| 3. Bridge double-version | audit `bridge/` parser, INDEX, and version ambiguity before any fix | repair only if verified defect exists; never edit a filed bridge file in place |
...
- Any write to `bridge/INDEX.md` or `bridge/*.md` outside the standard Loyal Opposition bridge-review surface (which is NOT this skill).
