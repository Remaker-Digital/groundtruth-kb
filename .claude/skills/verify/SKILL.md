...
- It does **NOT** write or mutate `bridge/INDEX.md`. The reviewer (or the
  existing helper-mediated bridge-write path) updates `bridge/INDEX.md`
  separately after the verdict file is written.
