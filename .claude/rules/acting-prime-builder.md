...
The canonical statement of this contract lives in
[`prime-builder-role.md`](prime-builder-role.md) § "AskUserQuestion as the Only
Valid Owner-Decision Channel" (the HYG-027 deduplication canonical home). The
block formerly duplicated here verbatim was removed to eliminate the
lockstep-edit hazard; consult that file for the active, mechanically-enforced
contract.
