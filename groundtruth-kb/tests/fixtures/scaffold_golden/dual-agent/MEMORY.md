# _test_golden_dual_agent Memory
...
- **Automations / schedules:** File bridge inventory and dispatcher daemon included; smart poller and OS poller retired in Slice 4 and archived
