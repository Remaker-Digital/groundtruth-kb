# CLAUDE.md — _test_golden_dual_agent

This file provides active guidance for AI assistants working on _test_golden_dual_agent.
It is loaded at the start of every session.

> **Customize this template:** Replace `_test_golden_dual_agent`, `Copyright 2026 GoldenFixtureOwner. All rights reserved.`, and
...
| Attribute | Value |
|-----------|-------|
| **Project Name** | _test_golden_dual_agent |
| **Type** | Dual Agent project |
