# Canonical Terminology — On-Demand Detail Reference
...
terms in full); this reference holds the full entries — alias, disambiguation,
source, and implementation pointer — for the non-required terms. Open this
file on demand when the core stub points here.

The core glossary remains the canonical DA read surface for term presence and
definitions; this reference is the authoritative full-detail companion. If the
two ever diverge, the entries here are the source for the moved detail fields.
