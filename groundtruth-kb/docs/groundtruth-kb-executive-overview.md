...
Multi-tenant data isolation and zero-knowledge security are architectural patterns that teams implement for their use case — they are not pre-built features of the current v0.7.0rc1 package.
