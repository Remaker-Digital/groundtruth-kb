...
4. **Phase 16.D** — Orphan test rationalization, two-phase.
   - **Phase 1 (phantom-link cleanup)** — 2,068 phantom `spec_id` values cleared to empty-string via bridge `por-step16d-phantom-link-cleanup` (2026-04-18); orphan pool unified at 2,322 tests ready for triage.
   - **Phase 2 (triage)** — classify each of the 2,322 orphans into link-to-existing-spec, create-new-spec, or retire categories. Follow-on bridge after Phase 1 VERIFIED.
