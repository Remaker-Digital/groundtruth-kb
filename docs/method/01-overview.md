...
The separation ensures that the agent building the system is not the same agent evaluating it. This catches blind spots, overconfidence, and scope creep. For details, see the [Dual-Agent Collaboration guide](06-dual-agent.md) (coming soon).
...
Session discipline prevents context loss across conversations and ensures that any team member (human or AI) can pick up where the last session left off. For details, see the [Session Discipline guide](07-sessions.md) (coming soon).
