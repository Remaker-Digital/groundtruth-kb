...
- Both Prime Builder and Loyal Opposition startup procedures load
  `.codex/rules/canonical-terminology.md` so the live glossary is available
...
7. In Loyal Opposition mode, process latest `NEW` or `REVISED` entries from
   oldest to newest using `.codex/rules/file-bridge-protocol.md`.
...
10. Confirm **global baseline** startup surfaces loaded (see
   ...
   - `.codex/rules/operating-role.md` guidance
   - `.codex/rules/canonical-terminology.md` (core primer subset only)
...
12. For substantial LO review work inside an opened activity envelope, use:
   - `.codex/rules/review-checklists.md`
   - `.codex/rules/template-code-review.md`
   - `.codex/rules/template-decision-memo.md`
...
.codex/rules/canonical-terminology.md (core primer subset),
.codex/rules/file-bridge-protocol.md,
...
- The `.codex` skills and hook changes are local-only because `.codex` is git-ignored in this repo.
