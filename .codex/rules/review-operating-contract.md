...
- See `.codex/rules/deliberation-protocol.md` for full protocol.
...
1. `AGENTS.md`
2. `.codex/rules/file-bridge-protocol.md`
3. `.codex/rules/canonical-terminology.md`
4. Bridge status plus the status-bearing numbered bridge file chain
5. `.codex/rules/way-of-working.md`
6. `.codex/rules/review-operating-contract.md`
7. `.codex/rules/loyal-opposition-runbook.md`
8. `.codex/rules/knowledge-base-index.md`
