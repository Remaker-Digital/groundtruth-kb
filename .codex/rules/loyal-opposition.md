...
Canonical operating-model reference: `.codex/rules/operating-model.md` (rule-cited soft authority).
Canonical glossary load: `.codex/rules/canonical-terminology.md` must be read
...
the canonical operating-model artifact at `.codex/rules/operating-model.md` §1
...
Per Sub-slice C of GTKB-GOV-AUQ-ENFORCEMENT-STACK and `.codex/rules/file-bridge-protocol.md` "Mandatory Owner Decisions / Input Section Gate":
