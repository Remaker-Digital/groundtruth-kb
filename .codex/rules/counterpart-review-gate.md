...
This rule auto-loads via `.codex/rules/` convention and is TRACKED in git.
...
(Active per Sub-slice C of GTKB-GOV-AUQ-ENFORCEMENT-STACK; mechanically enforced by `.codex/hooks/bridge-compliance-gate.py`.)
