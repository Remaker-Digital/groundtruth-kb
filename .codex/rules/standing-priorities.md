...
- The active Prime Builder / Loyal Opposition bridge is bridge
  state, with `.codex/rules/file-bridge-protocol.md` retained for legacy helper
...
- Load `.codex/rules/groundtruth-kb-vision.md` as persistent context for GroundTruth-related reviews and proposals.
