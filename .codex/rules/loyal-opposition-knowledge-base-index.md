...
## Active Rules under `.codex/rules/`
...
- `.codex/rules/canonical-terminology.md` — core primer subset only at startup;
  full corpus and activity-specific terms load on `::open <activity>`.
- `.codex/rules/file-bridge-protocol.md` — bridge statuses, gates, claim/preflight.
...
`.codex/skills/` adapters are generated from the canonical baseline skill source; no separate adapter
