...
Registry status: pending governed capability-registry update
Do not treat this adapter as registry-authoritative until config/agent-control/harness-capability-registry.toml includes skill.gtkb-sweep-commit.
GTKB-CODEX-SKILL-ADAPTER -->
