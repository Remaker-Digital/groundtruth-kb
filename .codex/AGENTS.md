...
*   **CI/CD & Configuration:** `.github/workflows/`, `.codex/hooks/`, `.codex/rules/`, `.codex/gtkb-hooks/`, `config/`
...
⦁	The following are generated projections and MUST NOT be edited directly: .codex/, .codex/, .goose/, .cursor/, .agent/, .api-harness/.
