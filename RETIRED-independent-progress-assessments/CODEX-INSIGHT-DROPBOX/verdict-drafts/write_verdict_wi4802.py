"""One-shot driver: write the LO GO verdict bridge file via the governed
...
DRAFT = (
    ...
    / "verdict-drafts"
    / "gtkb-wi4802-reconciler-duplicate-disposition-002-draft.md"
)
SLUG = "gtkb-wi4802-reconciler-duplicate-disposition"
VERSION = 2
