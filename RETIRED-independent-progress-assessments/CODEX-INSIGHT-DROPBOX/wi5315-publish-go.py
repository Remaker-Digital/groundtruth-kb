"""One-shot runner: inject fresh preflight output and publish the WI-5315 GO verdict.
...
SLUG = "gtkb-wi5315-recoverable-modernization-end-to-end-workflow"
VERSION = 2
BODY = ROOT / "independent-progress-assessments" / "CODEX-INSIGHT-DROPBOX" / "wi5315-go-verdict-002-body.txt"
