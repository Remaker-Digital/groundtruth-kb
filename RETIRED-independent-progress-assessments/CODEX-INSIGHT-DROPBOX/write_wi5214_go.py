"""One-shot governed-writer runner for the WI-5214 proposal-review GO verdict.
...
body_path = ROOT / "independent-progress-assessments" / "CODEX-INSIGHT-DROPBOX" / "wi5214-go-body.txt"
body = body_path.read_text(encoding="utf-8")
target = write_bridge_file("gtkb-wi5214-truthful-provider-read-pagination", 2, body, ROOT)
