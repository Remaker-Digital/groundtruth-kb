...
def _run_bridge_compliance_audit(
    *,
    ...
    gate_path = PROJECT_ROOT / "{{HARNESS_HOOKS_DIR}}" / "bridge-compliance-gate.py"
    payload = {
...
def propose_bridge(
    ...
    *,
    ...
    Glossary-source seeding from ``{{HARNESS_RULES_DIR}}/canonical-terminology.md``
    ...
    Args:
        ...
        glossary_path: Override the glossary path used for seeding.
            Defaults to ``{{HARNESS_RULES_DIR}}/canonical-terminology.md``.
