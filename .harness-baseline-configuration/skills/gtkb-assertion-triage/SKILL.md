...
`{{HARNESS_HOOKS_DIR}}/assertion-check.py` reads the latest run summary and surfaces
...
- `DCL-CONCEPT-ON-CONTACT-001` — load-bearing concepts have canonical glossary entries; see `{{HARNESS_RULES_DIR}}/canonical-terminology.md`.
