...
surface gap called out in {{HARNESS_RULES_DIR}}/bridge-essential.md. Dispatchable bridge
...
- Specific AskUserQuestion approval S341 (2026-05-11): "Approve adding a new
  ...
  bridge surfacing)?" → "Approve" (satisfies {{HARNESS_RULES_DIR}}/bridge-essential.md
