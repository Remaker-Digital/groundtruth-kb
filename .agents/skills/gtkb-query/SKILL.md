...
the sole record source. There is no SQLite database or legacy database class
to import, and no fallback when the service is unavailable: an unavailable
...
- Do not open a database file, import a legacy database class, or read another
