...
5. `.claude/rules/way-of-working.md`
6. `.claude/rules/review-operating-contract.md`
7. `.claude/rules/loyal-opposition-runbook.md`
8. `.claude/rules/knowledge-base-index.md`
