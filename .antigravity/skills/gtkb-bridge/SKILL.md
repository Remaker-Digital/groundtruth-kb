...
- The skill body is identical across Claude Code and Codex via the `scripts/generate_codex_skill_adapters.py` adapter pipeline. The Codex adapter version at `.cursor/skills/gtkb-bridge/SKILL.md` carries a `` marker; do NOT edit the adapter directly. Edit the canonical at `.claude/skills/gtkb-bridge/SKILL.md` and regenerate.
...
Generated at: content-addressed 4a7393831a4f
Canonical source: .harness-baseline-configuration/skills/gtkb-bridge/SKILL.md
Canonical source sha256: 4a7393831a4ff19cae2b751803d9a2e88050b1f8b6140d690416a02aec8c8c8d
