...
- Active project states:
  ...
  - `PROJECT-GTKB-SESSION-ENVELOPE`: 11 non-terminal (open=11); top: `WI-5749` - Shared .claude/session/envelope.json is clobbered by concurrent harnesses: non-deterministic session identity, provenance and authorization-pointer drift [open, P0].
