...
Version: 007
Responds to: bridge/gtkb-wi5662-canonical-doc-reference-recovery-006.md
...
slice and resolves every finding in v006. After independent GO, a PB claim,
...
### F1 — P1 — Malformed H19 fingerprint

H19 now carries the complete 64-character fingerprint ending `d7d48e3e`,
recomputed from the declared UTF-8/NUL row serialization including the literal
double quotes around `"<type(scope): message>"`.

### F2 — P1 — Four stale preimage anchors

H05, H14, H15, and H21 now identify their actual indexed preimage lines 135,
249, 250, and 198. Their row fingerprints and both affected target manifests
were recomputed from those corrected anchors. All other row fingerprints were
also independently recomputed; each remains unchanged.

### F3 — P1 — Duplicate active WI-5662 lifecycle

`gtkb-wi5662-canonical-doc-reference-recovery` is the sole controlling
continuation for WI-5662. The sibling threads
`gtkb-wi5662-canonical-skill-reference-repair` (latest v002 NO-GO) and
`gtkb-wi5662-skill-rename-canonical-doc-refs` (latest v010 NO-GO) are retained
as historical evidence only. They must not be appended, claimed, or used to
start implementation. Any future WI-5662 continuation must use this controller.

### F4 — P1 — Required verification baseline

The S1 smoke remains narrowed to the passing frontmatter contract. The full
...
| --- | --- | --- |
| .claude/skills/gtkb-bridge/SKILL.md | 60a86337c93f394a9905a6e890d126d5f2ff74ef | 20f30cfc91c1478bc1b68cac5a18c86a59a38f7d4ac06ade395604c5e95b3a07 |
...
| .claude/skills/gtkb-verify/SKILL.md | 58206159065e174124d941965a367939aaf0f864 | bfaebb75276875436324a3ae33e8991e06ba583e4d6c781dd3b937cab64eb728 |

Every row is mandatory with expected count one. Each row fingerprint is the
lowercase SHA-256 of the same UTF-8 row serialization defined below. No other
line may enter the cached patch.

The serialization is exact: encode each field as UTF-8; a row is
...
| H05 | gtkb-bridge line 135 | python .claude/skills/verify/helpers/write_verdict.py --slug <topic-slug> --body-file <draft-body-file> -> python .claude/skills/gtkb-verify/helpers/write_verdict.py --slug <topic-slug> --body-file <draft-body-file> | 25857caac9323d7064454f3e63f5ada17e9a2a75f7b7c2ffa79f66661d8eae99 |
...
| H14 | gtkb-bridge line 249 | .claude/skills/proposal-review/SKILL.md -> .claude/skills/gtkb-proposal-review/SKILL.md | 10a604ca2439f2f4a2fcfb249cde559f5eef3eb86061b70ed686770a0a0ba64d |
| H15 | gtkb-bridge line 250 | .claude/skills/send-review/SKILL.md -> .claude/skills/gtkb-send-review/SKILL.md | 07c07efe003b459e15fc766471b04e67eb62ccac1ac2ee1f80b4ab631217c5c0 |
...
| H19 | gtkb-verify line 115 | python .claude/skills/verify/helpers/write_verdict.py --slug <slug> --body-file <reviewed-verdict-body> --finalize-verified --no-prepopulate --commit-message "<type(scope): message>" --include <verified-path> [--include <verified-path> ...] -> python .claude/skills/gtkb-verify/helpers/write_verdict.py --slug <slug> --body-file <reviewed-verdict-body> --finalize-verified --no-prepopulate --commit-message "<type(scope): message>" --include <verified-path> [--include <verified-path> ...] | 955dbdbc74b30b75a3cb42373ec59903fe7cc032871f92f567c77326d7d48e3e |
...
| H21 | gtkb-verify line 198 | .codex/skills/verify/SKILL.md -> .codex/skills/gtkb-verify/SKILL.md | bb3d642972f9daadb054c66bc35cc6b30b76a445f7392065813344ebea9ce39d |
...
those eight hunks. H05 at anchor 135 is the sole independent helper line in the
...
No target-path change. Compared with v005, this revision corrects H19, the four
stale line anchors, their fingerprints, and both affected manifest hashes. It
also designates this thread as the sole controller and dispositions both sibling
threads as non-controlling historical evidence. It adds no implementation scope.
...
1. After GO, acquire the controller claim and obtain an implementation-start
   packet. Stop on any packet, blob, manifest, or worktree assertion failure.
...
| Controller uniqueness | Direct `gt bridge show` on all three named threads | Only this controller can continue WI-5662. |
...
- Generated adapters, templates, tests, policies, and historical artifacts are
  excluded.
- Both sibling threads remain historical/non-controlling and are not claimed,
