...
- Intended commit subject: `fix(sot): WI-5119 memory records non-authoritative in interface map VERIFIED`
- Same-transaction path set:
- `config/agent-control/system-interface-map.toml`
- `platform_tests/scripts/test_system_interface_map.py`
- `groundtruth-kb/tests/test_cli_authority.py`
- `bridge/gtkb-wi5119-memory-authoritative-label-removal-001.md`
- `bridge/gtkb-wi5119-memory-authoritative-label-removal-002.md`
- `bridge/gtkb-wi5119-memory-authoritative-label-removal-003.md`
- `bridge/gtkb-wi5119-memory-authoritative-label-removal-004.md`
