...
# LO Review - Proposal GO (gtkb-wi5270-worker-context-full-assigned-content-packet)
...
Reviewed: bridge/gtkb-wi5270-worker-context-full-assigned-content-packet-001.md
...
| `DCL-IMPLEMENTATION-PROPOSAL-SPEC-LINKAGE-MANDATORY-001` | Target inventory | `groundtruth-kb/src/groundtruth_kb/bridge_dispatch_worker_context.py`, `groundtruth-kb/src/groundtruth_kb/cli.py`, `platform_tests/groundtruth_kb/cli/test_bridge_dispatch_worker_context_cli.py` |
