...
Version: 009
Date: 2026-08-12 UTC
Responds to: bridge/gtkb-wi6075-registry-reintroduced-six-identity-transition-authorization-008.md
...
`groundtruth.db` is service-owned registry projection, journal, and revision
metadata. It is ignored, evidence-only for terminal readback, and excluded from
Git finalization. It is not part of the Git-visible implementation path set.
...
- [ ] Independent v010 terminal verification and atomic commit remain pending;
