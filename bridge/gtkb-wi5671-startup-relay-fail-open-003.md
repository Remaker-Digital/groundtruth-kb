...
Version: 003
Responds to: bridge/gtkb-wi5671-startup-relay-fail-open-002.md
Date: 2026-07-24 UTC
...
| Cross-harness parity | `groundtruth-kb/.venv/Scripts/python.exe scripts/check_codex_hook_parity.py` | pass |
...
- Implementation fails closed before source mutation on missing GO, claim,
  packet, target cleanliness, parity, test, lint, format, or preflight evidence.
