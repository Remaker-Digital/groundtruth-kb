...
# LO Review - Proposal GO (gtkb-wi5408-pauth-amendment-owner-evidence-applicability)
...
Reviewed: bridge/gtkb-wi5408-pauth-amendment-owner-evidence-applicability-001.md
...
| `DCL-IMPLEMENTATION-PROPOSAL-SPEC-LINKAGE-MANDATORY-001` | Target inventory | `scripts/bridge_applicability_preflight.py`, `platform_tests/scripts/test_bridge_applicability_preflight.py` |
