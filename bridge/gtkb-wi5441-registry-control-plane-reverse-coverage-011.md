...
# WI-5441 Registry Control Plane And Bridge Publication Currentness Revision

bridge_kind: prime_proposal
Document: gtkb-wi5441-registry-control-plane-reverse-coverage
Version: 011
Responds to: bridge/gtkb-wi5441-registry-control-plane-reverse-coverage-010.md
Date: 2026-07-25 UTC
...
terminal review. Its strict chain is now
...
siblings. Before WI-5441 terminal VERIFIED, independent review must close the
sibling v005 disposition or prove distinct work remains. No concurrent WI-5279
...
- current: `sha256:75d42ce230fa67967173be0ca00a9f14262fcf0d9db1295fc1357cbebc7842ec`;
...
v011 and its independent verdict necessarily use the defective writer before
the repair exists. After fresh GO, Prime acquires the exact claim/start packet:
...
6. WI-5279 base is not Prime-actionable and receives independent terminal
   disposition before WI-5441 terminal verification.
...
Review this as a revised implementation proposal, not a request to VERIFIED
v009. File GO only if typed publication authority, bootstrap, release ordering,
