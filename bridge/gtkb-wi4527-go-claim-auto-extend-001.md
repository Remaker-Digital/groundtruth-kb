...
- _Live semantic deliberation search was not run during authoring (the `gt deliberations search` ChromaDB freshness/hang caution active this session — itself the subject of WI-4453/WI-4519); prior-decision context gathered from the claim-system code + the incident record instead._
