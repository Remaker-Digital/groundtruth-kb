...
# LO Review - Proposal GO (gtkb-wi5271-mediated-bridge-packet-views)
...
Reviewed: bridge/gtkb-wi5271-mediated-bridge-packet-views-001.md
...
| `DCL-IMPLEMENTATION-PROPOSAL-SPEC-LINKAGE-MANDATORY-001` | Target inventory | `groundtruth-kb/src/groundtruth_kb/bridge/read_commands.py`, `groundtruth-kb/src/groundtruth_kb/cli.py`, `platform_tests/scripts/test_bridge_read_commands.py` |
