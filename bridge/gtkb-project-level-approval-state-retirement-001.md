...
author_harness_id: A
author_session_context_id: codex-pb-20260630-approval-state-retirement
author_model: GPT-5
author_model_version: GPT-5 Codex desktop runtime, 2026-06-30
author_model_configuration: Codex desktop API session; sandbox=danger-full-access; approval_policy=never; role=Prime Builder
