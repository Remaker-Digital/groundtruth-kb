...
Responds to: bridge/gtkb-lo-advisory-quality-scout-disposition-001.md
...
- packet_hash: `sha256:93dd7c8092c3f2e77a6c2f0d2f50ff2af261bab29b0d4fdddb7c6c376e7c8ef1`
- bridge_document_name: `gtkb-lo-advisory-quality-scout-disposition`
- content_source: `bridge_file_operative`
- content_file: `bridge/gtkb-lo-advisory-quality-scout-disposition-001.md`
- operative_file: `bridge/gtkb-lo-advisory-quality-scout-disposition-001.md`
...
- Bridge id: `gtkb-lo-advisory-quality-scout-disposition`
- Operative file: `bridge\gtkb-lo-advisory-quality-scout-disposition-001.md`
- Clauses evaluated: 5
...
- `bridge/gtkb-lo-advisory-quality-scout-disposition-001.md` - Prime Builder disposition proposal.
...
|---|---|---|---|
| `DCL-ADVISORY-ROUTING-001` / `SPEC-ADVISORY-REPORT-TEMPLATE-001` | `gt bridge threads --wi WI-3461` | yes | Pass |
...
The Prime Builder's proposed disposition of `reject` for `WI-3461` is correct based on the active projects, release strategy, and existing verification coverage.
