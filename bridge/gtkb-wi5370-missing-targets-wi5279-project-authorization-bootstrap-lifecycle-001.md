...
Archive and remove the malformed terminal VERIFIED artifact for gtkb-wi5279-project-authorization-bootstrap-lifecycle whose prior report/proposal lacks parseable target_paths.
...
All target paths are inside `E:\GT-KB`: `bridge/gtkb-wi5279-project-authorization-bootstrap-lifecycle-004.md`, `independent-progress-assessments/WI-5370-gtkb-wi5279-project-authorization-bootstrap-lifecycle-004.missing-targets-terminal.md`.
...
- Reconfirm bridge/gtkb-wi5279-project-authorization-bootstrap-lifecycle-004.md is an untracked terminal VERIFIED artifact and fails canonical finalization because the prior report/proposal lacks concrete target_paths or Files Expected To Change evidence.
- Archive the current live bytes (4315 bytes, SHA-256 31FE5C30CAD962AE0FA4D722F94040058518AD6BBB427A53C1C9445AD13250AF, Git blob b51f509e5e92b38f20ab8cf9b06084ac50cbf2c6) to independent-progress-assessments/WI-5370-gtkb-wi5279-project-authorization-bootstrap-lifecycle-004.missing-targets-terminal.md, verify byte/hash/blob equality, and remove only bridge/gtkb-wi5279-project-authorization-bootstrap-lifecycle-004.md.
...
- `independent-progress-assessments/WI-5370-gtkb-wi5279-project-authorization-bootstrap-lifecycle-004.missing-targets-terminal.md`
