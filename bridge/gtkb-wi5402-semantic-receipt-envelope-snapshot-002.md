...
# LO Review - Proposal GO (gtkb-wi5402-semantic-receipt-envelope-snapshot)
...
Reviewed: bridge/gtkb-wi5402-semantic-receipt-envelope-snapshot-001.md
...
| `DCL-IMPLEMENTATION-PROPOSAL-SPEC-LINKAGE-MANDATORY-001` | Target inventory | `scripts/check_modernization_scope_semantics.py`, `scripts/collect_modernization_semantic_evidence.py`, `platform_tests/scripts/test_modernization_scope_semantics.py`, `platform_tests/scripts/test_collect_modernization_semantic_evidence.py` |
