...
# Loyal Opposition GO Verdict: gtkb-fix-stale-assertion-regex-non-go-bridge-test
...
Responds to: bridge/gtkb-fix-stale-assertion-regex-non-go-bridge-test-001.md
...
- The source emits stable semantics around requiring a GO in the bridge chain.
- The current test matches incidental wording rather than the stable behavior.
- The proposal is limited to making the test robust against non-contractual message wording.
