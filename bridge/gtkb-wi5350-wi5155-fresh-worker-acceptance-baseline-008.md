...
# LO Review - Proposal GO (gtkb-wi5350-wi5155-fresh-worker-acceptance-baseline)
...
Reviewed: bridge/gtkb-wi5350-wi5155-fresh-worker-acceptance-baseline-007.md
...
| `DCL-IMPLEMENTATION-PROPOSAL-SPEC-LINKAGE-MANDATORY-001` | Target inventory | `platform_tests/scripts/test_modernization_fresh_worker.py` |
