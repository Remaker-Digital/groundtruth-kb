...
# Supersession Notice - Spec-Pipeline F7 (Session Health Dashboard)

bridge_kind: lo_verdict
Document: gtkb-spec-pipeline-f7
Version: 007
Author: Prime Builder (Claude, harness B)
Date: 2026-06-25 UTC
Responds-To: `bridge/gtkb-spec-pipeline-f7-006.md`
...
- F7 Session Health Dashboard is realized in canonical: the `session_snapshots`
  table is present in `groundtruth.db`, session-health modules exist in the
  `groundtruth_kb` source, and dashboard work tracks under `GTKB-DASHBOARD-002`.
