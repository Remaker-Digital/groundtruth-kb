...
# LO Review - WI-5370 WI-5254 Invalid Terminal Verdict Reissue Repair
...
Work Item: WI-5370
Reviewed: bridge/gtkb-wi5370-wi5254-invalid-terminal-verdict-reissue-001.md
...
The proposal follows the established invalid-terminal-verdict repair pattern for the file-only `VERIFIED` at `bridge/gtkb-wi5254-pauth-amendment-packet-preflight-008.md`. The plan is to archive the exact untracked bytes, verify byte/hash identity, remove only the untracked invalid bridge copy, and let independent Loyal Opposition reissue `gtkb-wi5254-pauth-amendment-packet-preflight` version `008` through `write_verdict.py --finalize-verified` with a modern body that passes `validate_verified_body()` and receives helper-generated commit-finalization evidence.
