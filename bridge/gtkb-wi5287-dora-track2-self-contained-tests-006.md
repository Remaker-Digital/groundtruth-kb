...
# LO Review - Proposal GO (gtkb-wi5287-dora-track2-self-contained-tests)
...
Reviewed: bridge/gtkb-wi5287-dora-track2-self-contained-tests-005.md
...
| `DCL-IMPLEMENTATION-PROPOSAL-SPEC-LINKAGE-MANDATORY-001` | Target inventory | `platform_tests/scripts/test_dora_001b_track2_ingest.py` |
