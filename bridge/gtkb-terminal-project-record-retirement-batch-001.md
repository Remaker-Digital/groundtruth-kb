...
author_harness_id: A
author_session_context_id: codex-pb-terminal-project-retirement-batch-20260601
author_model: GPT-5
author_model_version: gpt-5-codex
author_model_configuration: Codex desktop Prime Builder session

# Terminal Project Record Retirement Batch - Governance Review Proposal
...
Existing requirements are sufficient for this scoped governance correction. The
proposal does not introduce a new lifecycle rule; it applies the existing rule
that active project records should not remain active after their associated
work is terminal and no active authorization remains.
