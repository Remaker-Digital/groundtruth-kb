...
- Intended commit subject: `test: WI-4853 verify session-role marker claim-eligibility regression coverage (LO VERIFIED)`
- Same-transaction path set:
- `platform_tests/scripts/test_work_intent_role_eligibility.py`
- `bridge/gtkb-wi4853-session-role-marker-claim-eligibility-001.md`
- `bridge/gtkb-wi4853-session-role-marker-claim-eligibility-002.md`
- `bridge/gtkb-wi4853-session-role-marker-claim-eligibility-003.md`
- `bridge/gtkb-wi4853-session-role-marker-claim-eligibility-004.md`
