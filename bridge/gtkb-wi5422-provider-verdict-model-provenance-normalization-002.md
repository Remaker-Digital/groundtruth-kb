...
# LO Review - Proposal GO (gtkb-wi5422-provider-verdict-model-provenance-normalization)
...
Reviewed: bridge/gtkb-wi5422-provider-verdict-model-provenance-normalization-001.md
...
| `DCL-IMPLEMENTATION-PROPOSAL-SPEC-LINKAGE-MANDATORY-001` | Target inventory | `scripts/gtkb_bridge_writer.py`, `platform_tests/scripts/test_gtkb_bridge_writer.py` |
