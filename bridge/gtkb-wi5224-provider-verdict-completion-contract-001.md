...
# Implementation Proposal - Require governed verdict publication before provider bridge completion
...
- `GOV-FILE-BRIDGE-AUTHORITY-001` - the numbered bridge file chain is authoritative; prose cannot substitute for a status-bearing verdict file.
...
- Genuine dispatch evidence: F `2026-07-13T17-29-09Z-loyal-opposition-F-fdfb3f`, H `2026-07-13T17-40-06Z-loyal-opposition-H-d46646`, D `2026-07-14T08-07-46Z-loyal-opposition-D-7ff282`, and F `2026-07-14T08-45-27Z-loyal-opposition-F-5fc7f9` each demonstrate no-verdict completion or exit modes that this proposal addresses.
...
This proposal is filed under `bridge/` as the first status-bearing numbered bridge file for `gtkb-wi5224-provider-verdict-completion-contract`; no prior version is deleted or rewritten. Dispatcher/TAFE state plus the numbered file chain are the live workflow state per `GOV-FILE-BRIDGE-AUTHORITY-001`.
