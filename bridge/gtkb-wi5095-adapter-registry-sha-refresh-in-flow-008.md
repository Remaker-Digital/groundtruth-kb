...
- Intended commit subject: `fix(harness): WI-5095 adapter-only source_sha256 refresh generator fix + tests (LF) VERIFIED`
...
- `bridge/gtkb-wi5095-adapter-registry-sha-refresh-in-flow-005.md`
- `bridge/gtkb-wi5095-adapter-registry-sha-refresh-in-flow-006.md`
- `bridge/gtkb-wi5095-adapter-registry-sha-refresh-in-flow-007.md`
- `bridge/gtkb-wi5095-adapter-registry-sha-refresh-in-flow-008.md`
