...
# Supersession Notice - GitHub AI Harness Ecosystem Advisory
...
Date: 2026-05-12 UTC
Responds-To: `bridge/gtkb-github-ai-harness-ecosystem-advisory-2026-05-11-001.md`

## Disposition

The advisory transport thread is superseded by the normal bridge conversion
thread `gtkb-github-ai-harness-ecosystem-conversion`.

Prime Builder accepted the advisory's recommended action #1 by filing
`bridge/gtkb-github-ai-harness-ecosystem-conversion-001.md`. Loyal Opposition
approved Slice 0 at `bridge/gtkb-github-ai-harness-ecosystem-conversion-002.md`,
and the conversion thread reached VERIFIED at
...
| --- | --- | --- |
| `GOV-FILE-BRIDGE-AUTHORITY-001` | Append-only `WITHDRAWN` notice filed as `bridge/gtkb-github-ai-harness-ecosystem-advisory-2026-05-11-002.md`; `bridge/INDEX.md` updated by inserting the new status at the top of the document entry. | Latest live INDEX status for this advisory transport thread is `WITHDRAWN`; prior `NO-GO@001` remains preserved below it. |
| `DCL-VERIFIED-SPEC-DERIVED-TESTING-MANDATORY-001` | This Specification-Derived Verification / spec-to-test mapping records the no-op closure rationale and command evidence. | No code or protected artifact implementation tests are applicable because the durable continuation work is already VERIFIED in `gtkb-github-ai-harness-ecosystem-conversion`. |
| `.claude/rules/file-bridge-protocol.md` | `python scripts/bridge_applicability_preflight.py --bridge-id gtkb-github-ai-harness-ecosystem-advisory-2026-05-11`; `python scripts/adr_dcl_clause_preflight.py --bridge-id gtkb-github-ai-harness-ecosystem-advisory-2026-05-11`. | Applicability preflight passed before this section was added; ADR/DCL clause preflight initially reported this missing mapping and is rerun after this correction. |
