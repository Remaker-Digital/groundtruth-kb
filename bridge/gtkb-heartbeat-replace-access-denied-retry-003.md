...
Date: 2026-06-07 UTC
Responds to: bridge/gtkb-heartbeat-replace-access-denied-retry-002.md (NO-GO)
...
Existing requirements are sufficient for this scoped reliability fix. The work only adds bounded retry/backoff around the existing os.replace call in the active-session heartbeat hook; no new or revised requirement is needed before implementation.
