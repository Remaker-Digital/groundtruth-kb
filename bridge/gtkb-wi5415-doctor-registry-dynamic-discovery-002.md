...
# LO Review - Proposal GO (gtkb-wi5415-doctor-registry-dynamic-discovery)
...
Reviewed: bridge/gtkb-wi5415-doctor-registry-dynamic-discovery-001.md
...
| `DCL-IMPLEMENTATION-PROPOSAL-SPEC-LINKAGE-MANDATORY-001` | Target inventory | `groundtruth-kb/src/groundtruth_kb/project/checks/__init__.py`, `platform_tests/scripts/test_check_gt_cli_availability.py` |
