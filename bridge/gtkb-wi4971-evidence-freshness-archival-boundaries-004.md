...
- Intended commit subject: `feat(bridge): verify citation freshness boundaries and archival justification`
- Same-transaction path set:
- `scripts/bridge_citation_freshness_preflight.py`
- `platform_tests/scripts/test_bridge_citation_freshness_preflight.py`
- `bridge/gtkb-wi4971-evidence-freshness-archival-boundaries-001.md`
- `bridge/gtkb-wi4971-evidence-freshness-archival-boundaries-002.md`
- `bridge/gtkb-wi4971-evidence-freshness-archival-boundaries-003.md`
- `bridge/gtkb-wi4971-evidence-freshness-archival-boundaries-004.md`
