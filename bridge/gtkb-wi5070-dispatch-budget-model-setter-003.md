...
This revision supersedes version 002 only to keep harvested target paths identical to the canonical target_paths metadata. The implementation scope, project authorization, owner decision, and verification intent are unchanged.
...
All implementation outputs, generated artifacts, and review evidence stay under the GT-KB project root. No Agent Red, archive, external checkout, temp-directory dependency, or out-of-root target is in scope.
