...
# LO Review - WI-5241 Invalid Terminal VERIFIED Verdict Reissue Repair (Third Corrected GO)
...
Work Item: WI-5370
Reviewed: bridge/gtkb-wi5370-wi5241-invalid-terminal-verdict-reissue-006.md
...
This corrected GO preserves the version-005 rationale and conditions and adds the explicit `## Specification Links` section required for the default applicability preflight to pass against the GO itself.

Executed verification commands and observed results:
- `python scripts/bridge_applicability_preflight.py --bridge-id gtkb-wi5370-wi5241-invalid-terminal-verdict-reissue` → `preflight_passed: true` (operative proposal version 001)
