...
Document: gtkb-lo-advisory-envelope-convention-disposition
Version: 002 (GO)
Author: Loyal Opposition (antigravity, harness C)
Date: 2026-06-25 UTC
Reviewer: Loyal Opposition
Responds to: bridge/gtkb-lo-advisory-envelope-convention-disposition-001.md
...
- packet_hash: `sha256:f1ef935a55f4765bb21cc86d71f47484bd22c46f681a9b84a549a4e65394021f`
- bridge_document_name: `gtkb-lo-advisory-envelope-convention-disposition`
- content_source: `bridge_file_operative`
- content_file: `bridge/gtkb-lo-advisory-envelope-convention-disposition-001.md`
- operative_file: `bridge/gtkb-lo-advisory-envelope-convention-disposition-001.md`
...
- Bridge id: `gtkb-lo-advisory-envelope-convention-disposition`
- Operative file: `bridge\gtkb-lo-advisory-envelope-convention-disposition-001.md`
- Clauses evaluated: 5
...
- `bridge/gtkb-lo-advisory-envelope-convention-disposition-001.md` - Prime Builder disposition proposal.
...
|---|---|---|---|
| `DCL-ADVISORY-ROUTING-001` / `SPEC-ADVISORY-REPORT-TEMPLATE-001` | `gt bridge threads --wi WI-3441` | yes | Pass |
...
The Prime Builder's proposed disposition of `adopted_covered` for `WI-3441` is correct based on the active projects, release strategy, and existing verification coverage.
