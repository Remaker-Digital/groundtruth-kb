...
- Intended commit subject: `feat(harness): WI-5078 cloud harness native-full-hooks lifecycle wiring (slice 4a) VERIFIED`
- Same-transaction path set:
- `scripts/cloud_harness_base.py`
- `platform_tests/scripts/test_cloud_harness_base.py`
- `bridge/gtkb-cloud-harness-template-slice4a-native-hook-wiring-003.md`
- `bridge/gtkb-cloud-harness-template-slice4a-native-hook-wiring-004.md`
