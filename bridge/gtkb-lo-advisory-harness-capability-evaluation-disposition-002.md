...
Responds to: bridge/gtkb-lo-advisory-harness-capability-evaluation-disposition-001.md
...
- packet_hash: `sha256:0e72822b3e6bc173db23029266ed1870708a4aadb757103135f7941d18671ebf`
- bridge_document_name: `gtkb-lo-advisory-harness-capability-evaluation-disposition`
- content_source: `bridge_file_operative`
- content_file: `bridge/gtkb-lo-advisory-harness-capability-evaluation-disposition-001.md`
- operative_file: `bridge/gtkb-lo-advisory-harness-capability-evaluation-disposition-001.md`
...
- Bridge id: `gtkb-lo-advisory-harness-capability-evaluation-disposition`
- Operative file: `bridge\gtkb-lo-advisory-harness-capability-evaluation-disposition-001.md`
- Clauses evaluated: 5
...
- `bridge/gtkb-lo-advisory-harness-capability-evaluation-disposition-001.md` - Prime Builder disposition proposal.
...
|---|---|---|---|
| `DCL-ADVISORY-ROUTING-001` / `SPEC-ADVISORY-REPORT-TEMPLATE-001` | `gt bridge threads --wi WI-3389` | yes | Pass |
...
The Prime Builder's proposed disposition of `adopted_covered` for `WI-3389` is correct based on the active projects, release strategy, and existing verification coverage.
