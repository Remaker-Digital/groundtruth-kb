...
- Intended commit subject: `feat(dispatch): WI-5025 dispatcher complex-health two-dimension rollup (VERIFIED)`
...
- `bridge/gtkb-dispatcher-complex-health-rollup-001.md`
- `bridge/gtkb-dispatcher-complex-health-rollup-002.md`
- `bridge/gtkb-dispatcher-complex-health-rollup-003.md`
- `bridge/gtkb-dispatcher-complex-health-rollup-005.md`
- `bridge/gtkb-dispatcher-complex-health-rollup-006.md`
