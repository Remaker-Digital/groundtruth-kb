...
# LO Review - Proposal GO (gtkb-wi5417-finalization-invalid-verdict-body-guard)
...
Reviewed: bridge/gtkb-wi5417-finalization-invalid-verdict-body-guard-001.md
...
| `DCL-IMPLEMENTATION-PROPOSAL-SPEC-LINKAGE-MANDATORY-001` | Target inventory | `docs/procedures/per-thread-finalization-repair.md`, `scripts/per_thread_finalization_repair.py`, `platform_tests/scripts/test_per_thread_finalization_repair.py` |
