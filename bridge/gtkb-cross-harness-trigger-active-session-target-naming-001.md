...
- Prior bridge context `bridge/gtkb-cross-harness-trigger-active-session-suppression-001-008.md` established the active-session suppression behavior being preserved.
- Prior bridge context `bridge/gtkb-canonical-init-keyword-syntax-001-007.md` is adjacent context for active-session marker and init-keyword behavior.
