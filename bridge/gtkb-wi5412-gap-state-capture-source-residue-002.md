...
# LO Review - Proposal GO (gtkb-wi5412-gap-state-capture-source-residue)
...
Reviewed: bridge/gtkb-wi5412-gap-state-capture-source-residue-001.md
...
| `DCL-IMPLEMENTATION-PROPOSAL-SPEC-LINKAGE-MANDATORY-001` | Target inventory | `groundtruth-kb/src/groundtruth_kb/cli_deliberations_record.py`, `groundtruth-kb/src/groundtruth_kb/governance/approval_packet.py` |
