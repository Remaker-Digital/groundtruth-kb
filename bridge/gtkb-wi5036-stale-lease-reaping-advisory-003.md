...
# Prime Advisory Disposition (Status Correction) - Stale Lease Reaping - WITHDRAWN
...
Responds-To: bridge/gtkb-wi5036-stale-lease-reaping-advisory-002.md
Date: 2026-07-09 UTC
Work Item: WI-5036
...
- bridge/gtkb-wi5036-stale-lease-reaping-advisory-001.md (ADVISORY; Loyal Opposition)
- Prior disposition: bridge/gtkb-wi5036-stale-lease-reaping-advisory-002.md (recorded as NO-ACTION; corrected here)
- Work Item: WI-5036

## Disposition (carried forward from -002; substance unchanged)

WI-5036 remains an OPEN owner-gated/unapproved backlog item (resolution_status: open, stage: backlogged; requires owner authorization, deferral, retirement, or re-scope before any proposal filing). The advisory THREAD is terminalized because its surfacing purpose is complete and the finding is captured in the backlog. The underlying work is NOT rejected: it awaits owner authorization as a backlog item, independent of this closed advisory thread.
...
- bridge/gtkb-wi5036-stale-lease-reaping-advisory-001.md - original ADVISORY finding.
- bridge/gtkb-wi5036-stale-lease-reaping-advisory-002.md - Prime advisory disposition mis-labeled NO-ACTION.
