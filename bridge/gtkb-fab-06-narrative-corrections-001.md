...
target_paths: ["CLAUDE.md", "AGENTS.md", ".claude/rules/canonical-terminology.md", "scripts/assertion_categorize.py", "scripts/generate_governance_index.py", "platform_tests/scripts/**"]
...
# FAB-06 — Correct always-loaded narrative inaccuracies (CLAUDE.md / AGENTS.md)
