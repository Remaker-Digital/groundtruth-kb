...
- Intended commit subject: `feat(db): WI-5031 explicit SQLite busy_timeout on KnowledgeDB connections (VERIFIED)`
- Same-transaction path set:
- `groundtruth-kb/src/groundtruth_kb/db.py`
- `groundtruth-kb/tests/test_db_busy_timeout.py`
- `bridge/gtkb-wi5031-sqlite-busy-timeout-tuning-001.md`
- `bridge/gtkb-wi5031-sqlite-busy-timeout-tuning-002.md`
- `bridge/gtkb-wi5031-sqlite-busy-timeout-tuning-003.md`
- `bridge/gtkb-wi5031-sqlite-busy-timeout-tuning-004.md`
