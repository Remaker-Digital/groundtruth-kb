...
target_paths: ["bridge/gtkb-wi5354-git-lifecycle-acceptance-baseline-004.md", "independent-progress-assessments/WI-5370-wi5354-verdict-004.reappeared-invalid-finalizer.md"]
...
Archive and remove the current reappeared invalid terminal VERIFIED artifact for gtkb-wi5354-git-lifecycle-acceptance-baseline without touching source/test implementation paths.
...
All target paths are inside `E:\GT-KB`: `bridge/gtkb-wi5354-git-lifecycle-acceptance-baseline-004.md`, `independent-progress-assessments/WI-5370-wi5354-verdict-004.reappeared-invalid-finalizer.md`.
...
- Reconfirm bridge/gtkb-wi5354-git-lifecycle-acceptance-baseline-004.md is an untracked terminal VERIFIED artifact and fails canonical finalizer body validation.
- Archive the current live bytes (3547 bytes, SHA-256 EB145CE0A203A9D315A057FA875DD27CF5C8BED5B1687355252FDC9C84AFBFB5, Git blob fddf8c75edbb79753fe98e4dadd04a62178107da) to independent-progress-assessments/WI-5370-wi5354-verdict-004.reappeared-invalid-finalizer.md, verify byte/hash/blob equality, and remove only bridge/gtkb-wi5354-git-lifecycle-acceptance-baseline-004.md.
...
- gt bridge show gtkb-wi5354-git-lifecycle-acceptance-baseline --json --compact reports the pre-terminal implementation/report version after the invalid terminal file is removed.
...
- `independent-progress-assessments/WI-5370-wi5354-verdict-004.reappeared-invalid-finalizer.md`
