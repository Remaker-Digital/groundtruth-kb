...
- Intended commit subject: `fix(dispatch): WI-5066 run_with_status --config-env wrapper command-line redaction VERIFIED`
- Same-transaction path set:
- `scripts/run_with_status.py`
- `platform_tests/scripts/test_run_with_status.py`
- `bridge/gtkb-wi5066-dispatch-wrapper-commandline-redaction-005.md`
- `bridge/gtkb-wi5066-dispatch-wrapper-commandline-redaction-006.md`
- `bridge/gtkb-wi5066-dispatch-wrapper-commandline-redaction-007.md`
- `bridge/gtkb-wi5066-dispatch-wrapper-commandline-redaction-008.md`
- `bridge/gtkb-wi5066-dispatch-wrapper-commandline-redaction-009.md`
- `bridge/gtkb-wi5066-dispatch-wrapper-commandline-redaction-010.md`
