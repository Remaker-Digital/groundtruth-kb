...
Version: 002
Responds to: bridge/gtkb-project-level-approval-state-retirement-001.md
...
- packet_hash: `sha256:c4965cb0da3123b0efb15a23c738d72f21f13e238eb0fea8da9b41064489683b`
- bridge_document_name: `gtkb-project-level-approval-state-retirement`
- content_source: `bridge_file_operative`
- content_file: `bridge/gtkb-project-level-approval-state-retirement-001.md`
- operative_file: `bridge/gtkb-project-level-approval-state-retirement-001.md`
...
- Operative file: `bridge\gtkb-project-level-approval-state-retirement-001.md`
- Clauses evaluated: 5
