...
Document: gtkb-wi5370-no-responds-wi5347-wi5142-artifact-decontamination-baseline
Version: 001
Date: 2026-07-17 UTC
...
target_paths: ["bridge/gtkb-wi5347-wi5142-artifact-decontamination-baseline-004.md", "independent-progress-assessments/WI-5370-gtkb-wi5347-wi5142-artifact-decontamination-baseline-004.no-responds-terminal.md"]
...
Archive and remove the terminal VERIFIED artifact for `gtkb-wi5347-wi5142-artifact-decontamination-baseline` because the current per-thread repair planner cannot prove a finalizer-safe implementation scope for that terminal verdict.

Planner reason: Approved proposal is missing concrete target_paths or Files Expected To Change.

Source work items observed by planner: `WI-5142, WI-5172, WI-5335, WI-5347`.
...
All target paths are inside `E:\GT-KB`: `bridge/gtkb-wi5347-wi5142-artifact-decontamination-baseline-004.md` and `independent-progress-assessments/WI-5370-gtkb-wi5347-wi5142-artifact-decontamination-baseline-004.no-responds-terminal.md`.
...
- Reconfirm `bridge/gtkb-wi5347-wi5142-artifact-decontamination-baseline-004.md` is still the latest terminal VERIFIED artifact for `gtkb-wi5347-wi5142-artifact-decontamination-baseline` and is still classified as `terminal_verified_blocked_missing_scope` by `scripts/per_thread_finalization_repair.py`.
- Archive the current live bytes (3898 bytes, SHA-256 `D70E4D24020272A876A424E5BF8612FDA4DF70B6E063611683D26BBBB8F45319`, Git blob `4760005d1aa575bfc8260f2b3e926e169e179e88`) to `independent-progress-assessments/WI-5370-gtkb-wi5347-wi5142-artifact-decontamination-baseline-004.no-responds-terminal.md`, verify byte/hash/blob equality, and remove only `bridge/gtkb-wi5347-wi5142-artifact-decontamination-baseline-004.md`.
...
| Spec | Verification |
| --- | --- |
| `GOV-WORK-TREE-HYGIENE-001` | Run scoped `git status --short -- bridge/gtkb-wi5347-wi5142-artifact-decontamination-baseline-004.md independent-progress-assessments/WI-5370-gtkb-wi5347-wi5142-artifact-decontamination-baseline-004.no-responds-terminal.md` before and after; confirm no staged/index changes. |
| `GOV-FILE-BRIDGE-AUTHORITY-001` | Run `gt bridge show gtkb-wi5347-wi5142-artifact-decontamination-baseline --json --compact` before and after; confirm only the exact terminal file is removed from the live chain. |
...
- `gt bridge show gtkb-wi5347-wi5142-artifact-decontamination-baseline --json --compact` no longer reports `bridge/gtkb-wi5347-wi5142-artifact-decontamination-baseline-004.md` as the latest path after removal.
...
Risk is moderate because removing a terminal bridge artifact changes the live chain. The byte-identity guard and independent LO GO are mandatory. Rollback, before verification, is to restore only the archived bytes to `bridge/gtkb-wi5347-wi5142-artifact-decontamination-baseline-004.md` after revalidating the same SHA-256 and blob. Bridge files and reports remain append-only audit artifacts.

## Files Expected To Change

- `bridge/gtkb-wi5347-wi5142-artifact-decontamination-baseline-004.md`
- `independent-progress-assessments/WI-5370-gtkb-wi5347-wi5142-artifact-decontamination-baseline-004.no-responds-terminal.md`
