...
# LO Review - Proposal GO (gtkb-wi5419-in-root-root-resolution-fixture)
...
Reviewed: bridge/gtkb-wi5419-in-root-root-resolution-fixture-001.md
...
| `DCL-IMPLEMENTATION-PROPOSAL-SPEC-LINKAGE-MANDATORY-001` | Target inventory | `groundtruth-kb/tests/test_bridge_paths.py` |
