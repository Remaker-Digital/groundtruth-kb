...
| DCL-VERIFIED-SPEC-DERIVED-TESTING-MANDATORY-001 | `python -m pytest groundtruth-kb/tests/test_tafe_flow_definitions.py` | yes | PASS |
| GOV-ARTIFACT-ORIENTED-GOVERNANCE-001 | `preflight checks` | yes | PASS |
| GOV-FILE-BRIDGE-AUTHORITY-001 | `preflight checks` | yes | PASS |
| GOV-STANDING-BACKLOG-001 | `python -m pytest platform_tests/scripts/test_cli_backlog_status.py` | yes | PASS |
| SPEC-TAFE-R1 | `python -m pytest groundtruth-kb/tests/test_tafe_flow_definitions.py` | yes | PASS |
| SPEC-TAFE-R7 | `python -m pytest groundtruth-kb/tests/test_tafe_flow_definitions.py` | yes | PASS |
| SPEC-TYPED-ARTIFACT-FLOW-ENGINE-UMBRELLA | `python -m pytest groundtruth-kb/tests/test_tafe_flow_definitions.py` | yes | PASS |
...
python.exe -m pytest groundtruth-kb\tests\test_tafe_flow_definitions.py -q --tb=short
python.exe -m pytest groundtruth-kb\tests\test_tafe_flow_definitions.py -q --tb=short
python.exe -m pytest groundtruth-kb\tests\test_tafe_flow_definitions.py -q --tb=short
python.exe -m pytest groundtruth-kb\tests\test_cli_projects.py platform_tests\scripts\test_cli_backlog_status.py -q --tb=short
```
