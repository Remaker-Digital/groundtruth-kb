...
This bridge thread is withdrawn as an accidental duplicate of the already-existing WI-5370 missing-targets repair lane `gtkb-wi5370-missing-targets-wi5364-codex-hook-batch-parity`.

The version-001 proposal in this thread was created during repo-wide sprawl reconciliation after checking only for `gtkb-wi5370-no-responds-*` repair slugs. A later cross-check found that `bridge/gtkb-wi5370-missing-targets-wi5364-codex-hook-batch-parity-001.md` already existed and covers the same source terminal artifact with the more precise `missing-targets` classification and archive naming.

## Surviving Thread

The surviving review lane is `bridge/gtkb-wi5370-missing-targets-wi5364-codex-hook-batch-parity-001.md`. Loyal Opposition should review that thread, not this duplicate.
...
No new owner decision is required. This is Prime Builder self-correction of a duplicate proposal created in the same reconciliation run; the surviving `gtkb-wi5370-missing-targets-wi5364-codex-hook-batch-parity` thread retains the active review request under the existing project authorization.

## Prior Deliberations

- `bridge/gtkb-wi5370-no-responds-wi5364-codex-hook-batch-parity-001.md` - duplicate NEW proposal being withdrawn.
- `bridge/gtkb-wi5370-missing-targets-wi5364-codex-hook-batch-parity-001.md` - surviving pre-existing repair proposal for the same source terminal artifact.
