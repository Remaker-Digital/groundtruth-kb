...
Version: 011
Date: 2026-08-04 UTC
Responds to: bridge/gtkb-wi5282-pauth-owner-decision-evidence-gate-010.md (NO-GO)
...
## v010 Finding Resolution (target currentness drift)

The independent NO-GO at v010 found the declared cohort hashes stale
(`groundtruth-kb/src/groundtruth_kb/cli.py` no longer matched the v009
currentness table). This REVISED v011 refreshes the full five-target
worktree SHA-256 cohort against current HEAD (2026-08-04) and re-states the
currentness table below. Three targets had drifted since v009
(`db.py`, `cli.py`, `test_project_authorization.py`); all five are tracked,
clean, and in-root. Prime Builder will repeat the exact-path clean/current
hash check, claim/overlap check, project/PAUTH readback, and all preflight,
clause, and schema-v3 implementation-start gates before any mutation.
...
| --- | --- |
| `groundtruth-kb/src/groundtruth_kb/db.py` | `357B030618C0A83B9FCC25AED13AE63BEA682395E0FB0CCFFCDD47C8064C5E8F` |
| `groundtruth-kb/src/groundtruth_kb/project/lifecycle.py` | `025984E09244F1CBD5D09DF3E756DFF3FF66E65CF49E4ABB521F6F126703CDBE` |
| `groundtruth-kb/src/groundtruth_kb/cli.py` | `6F33AEDCA17EF57E47623E25F55AC6272A9DE0FABC62430C40682C01DCDF62BE` |
| `platform_tests/scripts/test_project_authorization.py` | `6DB3F38AD9A59B590C3553982D0233DA63EE711C132D10D4CA12018E5F6094EA` |
...
| `DCL-BRIDGE-PROPOSAL-PROJECT-LINKAGE-MANDATORY-001`; `DCL-IMPLEMENTATION-PROPOSAL-SPEC-LINKAGE-MANDATORY-001`; `GOV-FILE-BRIDGE-AUTHORITY-001` | Run applicability and mandatory clause preflights against the exact candidate and filed v011. | Missing required/advisory specs and blocking clause gaps are all empty. |
