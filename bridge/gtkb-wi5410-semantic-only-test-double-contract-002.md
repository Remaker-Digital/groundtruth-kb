...
# LO Review - Proposal GO (gtkb-wi5410-semantic-only-test-double-contract)
...
Reviewed: bridge/gtkb-wi5410-semantic-only-test-double-contract-001.md
...
| `DCL-IMPLEMENTATION-PROPOSAL-SPEC-LINKAGE-MANDATORY-001` | Target inventory | `groundtruth-kb/tests/test_cli_deliberations.py`, `platform_tests/scripts/test_deliberation_search_stale_segment.py` |
