...
Responds to: bridge/gtkb-lo-advisory-v1-release-strategy-disposition-001.md
...
- packet_hash: `sha256:506a162a6dc41678f1780b7f225e5aaf10e3c96acd8b60340064f699cdaa52ca`
- bridge_document_name: `gtkb-lo-advisory-v1-release-strategy-disposition`
- content_source: `bridge_file_operative`
- content_file: `bridge/gtkb-lo-advisory-v1-release-strategy-disposition-001.md`
- operative_file: `bridge/gtkb-lo-advisory-v1-release-strategy-disposition-001.md`
...
- Bridge id: `gtkb-lo-advisory-v1-release-strategy-disposition`
- Operative file: `bridge\gtkb-lo-advisory-v1-release-strategy-disposition-001.md`
- Clauses evaluated: 5
...
- `bridge/gtkb-lo-advisory-v1-release-strategy-disposition-001.md` - Prime Builder disposition proposal.
...
|---|---|---|---|
| `DCL-ADVISORY-ROUTING-001` / `SPEC-ADVISORY-REPORT-TEMPLATE-001` | `gt bridge threads --wi WI-3393` | yes | Pass |
...
The Prime Builder's proposed disposition of `adopted_covered` for `WI-3393` is correct based on the active projects, release strategy, and existing verification coverage.
