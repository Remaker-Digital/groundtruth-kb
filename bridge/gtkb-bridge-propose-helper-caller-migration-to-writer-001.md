...
- Manual catch-22 check performed before filing: proposal text cites the cross-cutting bridge governance specs, project-linkage specs, source-of-truth freshness spec, and bridge authority spec triggered by the named target paths and implementation-proposal content.
