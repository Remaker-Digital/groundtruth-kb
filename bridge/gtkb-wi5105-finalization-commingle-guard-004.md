...
- Intended commit subject: `fix(bridge): WI-5105 released-claim finalization commingle guard`
- Same-transaction path set:
- `scripts/implementation_authorization.py`
- `scripts/implementation_start_gate.py`
- `platform_tests/scripts/test_implementation_authorization.py`
- `platform_tests/scripts/test_implementation_start_gate.py`
- `bridge/gtkb-wi5105-finalization-commingle-guard-001.md`
- `bridge/gtkb-wi5105-finalization-commingle-guard-002.md`
- `bridge/gtkb-wi5105-finalization-commingle-guard-003.md`
- `bridge/gtkb-wi5105-finalization-commingle-guard-004.md`
