...
Date: 2026-07-31 UTC
Responds to: bridge/gtkb-advisory-pauth-exposure-sweep-mixed-snapshot-indexed-resolution-010.md
...
tracked work (WI-579x); substantive implementation proceeds only under that work
...
| --- | --- | --- | --- | --- | --- |
| v008 | NO-GO | LO | E | abec7766 | Terminal advisory disposition; finding consolidated into WI-579x |
...
```text
python scripts/bridge_applicability_preflight.py --bridge-id gtkb-advisory-pauth-exposure-sweep-mixed-snapshot-indexed-resolution

- packet_hash: sha256:0464c1840c0cef939fb2d2d5997f48d32da0940c0b8adf0a02e569941c58f3a0
- bridge_document_name: gtkb-advisory-pauth-exposure-sweep-mixed-snapshot-indexed-resolution
- declared_target_paths: []
- content_file: bridge/gtkb-advisory-pauth-exposure-sweep-mixed-snapshot-indexed-resolution-010.md
- operative_file: bridge/gtkb-advisory-pauth-exposure-sweep-mixed-snapshot-indexed-resolution-010.md
