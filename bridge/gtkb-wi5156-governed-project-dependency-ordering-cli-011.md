...
- Read `.claude/skills/verify/helpers/write_verdict.py` in full (validation, hunk-patch resolution, predecessor-chain-committed, review-independence, and synthetic-session-id checks)
...
- Intended commit subject: `feat(projects): verify governed project dependency ordering cli`
- Same-transaction path set:
- `bridge/gtkb-wi5156-governed-project-dependency-ordering-cli-001.md`
- `bridge/gtkb-wi5156-governed-project-dependency-ordering-cli-002.md`
...
- `bridge/hunks/gtkb-wi5156-projects-projection-hunks.patch`
