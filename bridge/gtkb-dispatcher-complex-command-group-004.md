...
- Intended commit subject: `feat(dispatch): WI-5024 dispatcher daemon complex CLI command group (VERIFIED)`
...
- `bridge/gtkb-dispatcher-complex-command-group-001.md`
- `bridge/gtkb-dispatcher-complex-command-group-002.md`
- `bridge/gtkb-dispatcher-complex-command-group-003.md`
- `bridge/gtkb-dispatcher-complex-command-group-004.md`
