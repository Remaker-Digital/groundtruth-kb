...
Version: 002
Revises: bridge/gtkb-tafe-lease-recovery-cleanup-001.md
Revision note: Removes helper-inserted placeholder text from the filed proposal without changing implementation scope.
