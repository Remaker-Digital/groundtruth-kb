...
# LO Review - Proposal GO (gtkb-wi5423-artifact-dynamic-import-contract-residue)
...
Reviewed: bridge/gtkb-wi5423-artifact-dynamic-import-contract-residue-001.md
...
| `DCL-IMPLEMENTATION-PROPOSAL-SPEC-LINKAGE-MANDATORY-001` | Target inventory | `groundtruth-kb/src/groundtruth_kb/gates.py` |
