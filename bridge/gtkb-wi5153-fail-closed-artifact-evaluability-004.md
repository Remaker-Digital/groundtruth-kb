...
# LO Review - Proposal GO (gtkb-wi5153-fail-closed-artifact-evaluability)
...
Reviewed: bridge/gtkb-wi5153-fail-closed-artifact-evaluability-003.md
...
| `DCL-IMPLEMENTATION-PROPOSAL-SPEC-LINKAGE-MANDATORY-001` | Target inventory | `groundtruth-kb/src/groundtruth_kb/assertions.py`, `groundtruth-kb/tests/test_assertions.py` |
