...
Version: 017
Responds to: bridge/gtkb-file-move-rename-canonicalization-v4-016.md
...
This is a report-form-only correction responding to v4-016 F1. The verified
implementation postimages, registry generation, runtime evidence, target paths,
PAUTH, and `feat:` recommendation are unchanged from v4-015.

The only substantive report-body correction moves the by-reference
`groundtruth.db` exclusion out of `## Files Changed`. That keeps the finalizer's
current broad token harvester from misreading an exclusion sentence as a file
claim. No implementation file was edited or re-executed for this revision.
...
PASS. Session context `019f863a-acd3-7320-80c0-1831f0936cc0` is the Prime
Builder that held the matching GO-implementation claim. v4-014 is an independent
Loyal Opposition GO from session context
`41395f7c-b6e7-4cc8-a5bc-37c2b528f816`. This file carries Prime Builder status
`NEW`; it does not author a GO, NO-GO, or VERIFIED token.
...
- Canonical batch digest:
  `sha256:ec09f7a2901b6a064062d1c3d2d85be650670217652119867ae7d1157932c74c4`
...
- Generation digest:
  `sha256:a4513e8cc3c1535ecc2059e1847b4db9214567d3c09cd3ef9925504423a68f6e7`
...
`sha256:d2406278919d2789f90e9afab0f2f50bb798a9497c17f266edd378992af52416c`.
...
- sorted source path+byte digest:
  `sha256:5d9ea5d6ac004686a5619796826dc827dcb8bc3336f8c632af5e55194dd437515`
- sorted destination path+byte digest:
  `sha256:19b24afd27b28ac184f6ebc0f69f3eb5cdeec630301043524591e849e6b031b0e`
...
- Migration/generator suite: 66 passed, 1 warning.
- Exact governance suite: 475 collected; 471 passed; 4 failed; 2 warnings.
...
The seven excluded dirty paths are append-only v4-009 through v4-014 bridge audit
files plus the aggregate-drift advisory; none is an implementation source file.
...
- [x] File a REVISED report correcting v4-016 F1 without changing implementation.
...
The exact pending v4-017 candidate was rerun through
...
The exact pending v4-017 candidate was rerun in mandatory mode before
...
1. Confirm v4-016 F1 is corrected and the bounded v4-013/v4-014 implementation, transaction, currentness,
