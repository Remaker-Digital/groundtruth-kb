...
# Implementation Proposal - WI-5370 tracked terminal byte-ownership repair for WI-4856 daemon status liveness accuracy
...
- Source artifact: `bridge/gtkb-wi4856-daemon-status-liveness-accurate-004.md`.
- Current working-tree bytes: length `1562`, SHA-256 `BF9A7B5A9AF76F7F673A4A3C3A282C8A2689C39FBB7ED52A3EA09F86F4D30981`, Git blob `cba39b5e29a82cb4ab3388821479e2cff87c5d2b`.
- Committed HEAD bytes: length `6361`, SHA-256 `ECC27DACAC76E3B657FFC6AF7523B72DB227DF23F2F3982988CFE512152AF135`, Git blob `6422b4095e7274a95da03755b7215b10b1388c41`.
...
- Work items in source thread: WI-4855, WI-4856, WI-4862.
...
Both declared target paths are inside `E:/GT-KB`: `bridge/gtkb-wi4856-daemon-status-liveness-accurate-004.md` and `independent-progress-assessments/WI-5370-gtkb-wi4856-daemon-status-liveness-accurate-004.current-modified-terminal.md`.
...
- Reconfirm immediately before mutation that `bridge/gtkb-wi4856-daemon-status-liveness-accurate-004.md` still has current length `1562`, SHA-256 `BF9A7B5A9AF76F7F673A4A3C3A282C8A2689C39FBB7ED52A3EA09F86F4D30981`, and Git blob `cba39b5e29a82cb4ab3388821479e2cff87c5d2b`.
- Reconfirm the committed HEAD identity for `bridge/gtkb-wi4856-daemon-status-liveness-accurate-004.md` is blob `6422b4095e7274a95da03755b7215b10b1388c41` with SHA-256 `ECC27DACAC76E3B657FFC6AF7523B72DB227DF23F2F3982988CFE512152AF135`.
- Acquire a work-intent claim for this proposal and run implementation-start authorization before any file mutation.
- Copy the exact current working-tree bytes to `independent-progress-assessments/WI-5370-gtkb-wi4856-daemon-status-liveness-accurate-004.current-modified-terminal.md` after verifying both absolute paths remain under `E:/GT-KB`.
- Verify archive byte length, SHA-256, Git blob, and raw byte equality against the source before altering the source path.
- Restore only `bridge/gtkb-wi4856-daemon-status-liveness-accurate-004.md` to the committed HEAD blob `6422b4095e7274a95da03755b7215b10b1388c41` after archive identity passes.
- Verify `bridge/gtkb-wi4856-daemon-status-liveness-accurate-004.md` is clean relative to HEAD and the archive remains byte-identical to the pre-repair current bytes.
...
- `independent-progress-assessments/WI-5370-gtkb-wi4856-daemon-status-liveness-accurate-004.current-modified-terminal.md` exists and is byte-identical to the current pre-repair working-tree bytes of `bridge/gtkb-wi4856-daemon-status-liveness-accurate-004.md`.
- `bridge/gtkb-wi4856-daemon-status-liveness-accurate-004.md` is restored to committed HEAD blob `6422b4095e7274a95da03755b7215b10b1388c41` and no longer appears as a tracked modification.
...
Risk is bounded to one tracked bridge verdict file plus one archive. The main risk is another session changing the live bytes between review and implementation; mitigation is mandatory pre-mutation byte identity checking and fail-closed behavior. Rollback, if needed before verification, is to restore the archived bytes to `bridge/gtkb-wi4856-daemon-status-liveness-accurate-004.md` after validating the archive hash.

## Files Expected To Change

- `bridge/gtkb-wi4856-daemon-status-liveness-accurate-004.md`
- `independent-progress-assessments/WI-5370-gtkb-wi4856-daemon-status-liveness-accurate-004.current-modified-terminal.md`
