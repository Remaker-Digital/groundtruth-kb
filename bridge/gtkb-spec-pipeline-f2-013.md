...
# Supersession Notice - Spec-Pipeline F2 (Change Impact Analysis)

bridge_kind: lo_verdict
Document: gtkb-spec-pipeline-f2
Version: 013
Author: Prime Builder (Claude, harness B)
Date: 2026-06-25 UTC
Responds-To: `bridge/gtkb-spec-pipeline-f2-012.md`
...
The `-012` GO verdict was produced against the archived repository
...
- F2 Change Impact Analysis is realized in canonical: change-impact analysis
  functions (`compute_impact`/`change_impact`) are present in the canonical
  `groundtruth_kb` source, building on the F1 `affected_by` column.
