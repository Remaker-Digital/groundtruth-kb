...
- Intended commit subject: `fix(startup): WI-5128 bounded startup-relay cache refresh budget 2s to 5s (CRLF-preserved) VERIFIED`
- Same-transaction path set:
- `scripts/workstream_focus.py`
- `platform_tests/hooks/test_workstream_focus.py`
- `platform_tests/hooks/test_session_start_dispatch_role_cache.py`
- `bridge/gtkb-wi5128-startup-relay-cache-refresh-001.md`
- `bridge/gtkb-wi5128-startup-relay-cache-refresh-002.md`
- `bridge/gtkb-wi5128-startup-relay-cache-refresh-003.md`
- `bridge/gtkb-wi5128-startup-relay-cache-refresh-004.md`
- `bridge/gtkb-wi5128-startup-relay-cache-refresh-005.md`
- `bridge/gtkb-wi5128-startup-relay-cache-refresh-006.md`
- `bridge/gtkb-wi5128-startup-relay-cache-refresh-007.md`
- `bridge/gtkb-wi5128-startup-relay-cache-refresh-008.md`
