...
# LO Review - Proposal GO (gtkb-authority-foundations-project-authorization)
...
Reviewed: bridge/gtkb-authority-foundations-project-authorization-009.md
...
| `DCL-IMPLEMENTATION-PROPOSAL-SPEC-LINKAGE-MANDATORY-001` | Target inventory | `groundtruth.db` |
