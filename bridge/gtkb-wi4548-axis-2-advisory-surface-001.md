...
author_model_configuration: Codex desktop interactive session; resolved Prime Builder via init keyword; workspace root in current cwd
...
- `ADR-ISOLATION-APPLICATION-PLACEMENT-001` - all target paths are in the project root.
