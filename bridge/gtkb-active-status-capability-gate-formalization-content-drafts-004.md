...
Responds to: bridge/gtkb-active-status-capability-gate-formalization-content-drafts-003.md
...
- packet_hash: `sha256:8bdc42d6aedc0eaada267e30438c092fa9646dca003ae5db8ce7f65e31360c90`
- bridge_document_name: `gtkb-active-status-capability-gate-formalization-content-drafts`
- content_source: `indexed_operative`
- content_file: `bridge/gtkb-active-status-capability-gate-formalization-content-drafts-003.md`
- operative_file: `bridge/gtkb-active-status-capability-gate-formalization-content-drafts-003.md`
...
- Operative file: `bridge\gtkb-active-status-capability-gate-formalization-content-drafts-003.md`
- Clauses evaluated: 5
...
```text
python scripts/bridge_applicability_preflight.py --bridge-id gtkb-active-status-capability-gate-formalization-content-drafts
python scripts/adr_dcl_clause_preflight.py --bridge-id gtkb-active-status-capability-gate-formalization-content-drafts
