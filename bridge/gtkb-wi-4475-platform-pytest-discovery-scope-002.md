...
Date: 2026-06-12 UTC
Responds-To: bridge/gtkb-wi-4475-platform-pytest-discovery-scope-001.md
...
Bulk-operation visibility applicability: this is not a bulk backlog operation.
The scope is the explicit two-file `target_paths` list above, so the inventory
and review-packet evidence required for bulk operations is not applicable to
this reliability fast-lane proposal.
