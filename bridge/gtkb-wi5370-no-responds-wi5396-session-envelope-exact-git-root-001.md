...
Archive and remove the terminal VERIFIED artifact for `gtkb-wi5396-session-envelope-exact-git-root` because the current per-thread repair planner cannot prove a finalizer-safe implementation scope for that terminal verdict.

Planner reason: latest VERIFIED verdict has no Responds to report reference.

Source work items observed by planner: `WI-4893, WI-5371, WI-5396`.
...
All target paths are inside `E:\GT-KB`: `bridge/gtkb-wi5396-session-envelope-exact-git-root-008.md` and `independent-progress-assessments/WI-5370-gtkb-wi5396-session-envelope-exact-git-root-008.no-responds-terminal.md`.
...
- Reconfirm `bridge/gtkb-wi5396-session-envelope-exact-git-root-008.md` is still the latest terminal VERIFIED artifact for `gtkb-wi5396-session-envelope-exact-git-root` and is still classified as `terminal_verified_blocked_missing_scope` by `scripts/per_thread_finalization_repair.py`.
- Archive the current live bytes (1815 bytes, SHA-256 `51D60BC010FF343010025357DA5E08BA3156DEA59D4F4A4BFE4C6F8A59C7A9DF`, Git blob `79d634b19c520012258fcd93d398718c52142187`) to `independent-progress-assessments/WI-5370-gtkb-wi5396-session-envelope-exact-git-root-008.no-responds-terminal.md`, verify byte/hash/blob equality, and remove only `bridge/gtkb-wi5396-session-envelope-exact-git-root-008.md`.
...
| Spec | Verification |
| --- | --- |
| `GOV-WORK-TREE-HYGIENE-001` | Run scoped `git status --short -- bridge/gtkb-wi5396-session-envelope-exact-git-root-008.md independent-progress-assessments/WI-5370-gtkb-wi5396-session-envelope-exact-git-root-008.no-responds-terminal.md` before and after; confirm no staged/index changes. |
| `GOV-FILE-BRIDGE-AUTHORITY-001` | Run `gt bridge show gtkb-wi5396-session-envelope-exact-git-root --json --compact` before and after; confirm only the exact terminal file is removed from the live chain. |
...
- `gt bridge show gtkb-wi5396-session-envelope-exact-git-root --json --compact` no longer reports `bridge/gtkb-wi5396-session-envelope-exact-git-root-008.md` as the latest path after removal.
...
Risk is moderate because removing a terminal bridge artifact changes the live chain. The byte-identity guard and independent LO GO are mandatory. Rollback, before verification, is to restore only the archived bytes to `bridge/gtkb-wi5396-session-envelope-exact-git-root-008.md` after revalidating the same SHA-256 and blob. Bridge files and reports remain append-only audit artifacts.

## Files Expected To Change

- `bridge/gtkb-wi5396-session-envelope-exact-git-root-008.md`
- `independent-progress-assessments/WI-5370-gtkb-wi5396-session-envelope-exact-git-root-008.no-responds-terminal.md`
