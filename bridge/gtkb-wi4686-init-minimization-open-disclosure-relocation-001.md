...
author_model: gpt-5
author_model_version: gpt-5-codex-desktop-2026-06-23
author_model_configuration: Codex Desktop; approval_policy=never; role=prime-builder; cwd=E:/GT-KB
author_metadata_source: explicit-codex-desktop-runtime

# Implementation Proposal - WI-4686 Init Minimization and Open-Disclosure Relocation
...
- `GOV-FILE-BRIDGE-AUTHORITY-001` - Prime Builder may author NEW proposals; Loyal Opposition owns GO/NO-GO/VERIFIED.
...
- This proposal does not request new owner input and does not require formal-artifact mutation approval.

## Pre-Filing Preflight

- Applicability preflight: `python scripts/bridge_applicability_preflight.py --bridge-id gtkb-wi4686-init-minimization-open-disclosure-relocation --content-file .gtkb-state\bridge-proposal-drafts\gtkb-wi4686-init-minimization-open-disclosure-relocation-001.md --json`
  - `preflight_passed: true`
  - `missing_required_specs: []`
  - `missing_advisory_specs: []`
  - `packet_hash: sha256:ebb607546d51accba1bb883584a99009ead1d05487a9080332b56f1df1f74c37`
- Clause preflight: `python scripts/adr_dcl_clause_preflight.py --bridge-id gtkb-wi4686-init-minimization-open-disclosure-relocation --content-file .gtkb-state\bridge-proposal-drafts\gtkb-wi4686-init-minimization-open-disclosure-relocation-001.md`
  - Exit code: `0`
