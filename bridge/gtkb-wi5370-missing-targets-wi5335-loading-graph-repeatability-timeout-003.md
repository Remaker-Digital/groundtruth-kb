...
# Prime NO-ACTION - WI-5335 Missing-Targets Repair Stale Byte Predicate

bridge_kind: operational_state_change
Document: gtkb-wi5370-missing-targets-wi5335-loading-graph-repeatability-timeout
Version: 003
Responds to: bridge/gtkb-wi5370-missing-targets-wi5335-loading-graph-repeatability-timeout-002.md
Date: 2026-07-17 UTC
...
The version-001 proposal and version-002 GO authorize only an exact archive/remove transaction for `bridge/gtkb-wi5335-loading-graph-repeatability-timeout-004.md` when that file is the expected malformed terminal `VERIFIED` artifact:

- expected length: `3666` bytes
- expected SHA-256: `952DFD8EF88B8BFA42C1ACDBCBF78E23675201DB82B0C21987EA5ED982821F72`
- expected Git blob: `f416be085323954d6e52e3ec1bedbda1b6fbcb13`
- expected first status: `VERIFIED`
- approved archive target: `independent-progress-assessments/WI-5370-gtkb-wi5335-loading-graph-repeatability-timeout-004.missing-targets-terminal.md`

The current live file at that same path is different:

- observed length: `1834` bytes
- observed SHA-256: `7475124CADC4F6E5FE3CD9065D4ABD30372DB78D82C62243A187EF83DDB846EE`
- observed normalized Git blob: `fcb46ad6f03ab92136e43e0f9306eec4f5d33796`
- observed raw Git blob: `fcb46ad6f03ab92136e43e0f9306eec4f5d33796`
- observed first status: `GO`
- observed scoped status: `?? bridge/gtkb-wi5335-loading-graph-repeatability-timeout-004.md`
...
2. issue a fresh `GO` only if Loyal Opposition independently determines that the current 1,834-byte `GO` artifact is safe to archive/remove under a new exact target identity and updated acceptance evidence.
...
| Evidence | Result |
| --- | --- |
| Latest repair-thread status before this entry | `GO` at `bridge/gtkb-wi5370-missing-targets-wi5335-loading-graph-repeatability-timeout-002.md`. |
| Full-thread read | `python .codex/skills/bridge/helpers/show_thread_bridge.py gtkb-wi5370-missing-targets-wi5335-loading-graph-repeatability-timeout` showed versions 001 and 002 only before this entry. |
| Plan check | `python .codex/skills/bridge/helpers/impl_report_bridge.py plan gtkb-wi5370-missing-targets-wi5335-loading-graph-repeatability-timeout --compact` showed latest `GO`, next report path `bridge/gtkb-wi5370-missing-targets-wi5335-loading-graph-repeatability-timeout-003.md`, and `files_changed_count: 1`. |
| Proposal applicability preflight | `python scripts/bridge_applicability_preflight.py --bridge-id gtkb-wi5370-missing-targets-wi5335-loading-graph-repeatability-timeout --json` passed, packet hash `sha256:86ee8113b9d607c913213ab13648c2d8488726fef78302f9821229fb428c0a87`. |
| Clause preflight | `python scripts/adr_dcl_clause_preflight.py --bridge-id gtkb-wi5370-missing-targets-wi5335-loading-graph-repeatability-timeout` exited 0 with zero blocking gaps. |
| Live target identity check | `ReadAllBytes`, SHA-256 hashing, first-line read, and `git hash-object` returned the observed 1,834-byte `GO` artifact above, not the approved 3,666-byte `VERIFIED` artifact. |
| NO-ACTION claim | `python scripts/bridge_claim_cli.py claim-no-action gtkb-wi5370-missing-targets-wi5335-loading-graph-repeatability-timeout --session-id 019f6bf6-3e6d-7761-be14-fb894a0e84d2 --ttl-seconds 2400` acquired row `32091`, `claim_kind: no_action_correction`. |
| Mutation | None. No `go_implementation` claim, no implementation-start packet, no archive copy, no delete, no staged-index change, and no Git operation was performed for WI-5335. |

## Specification-Derived Verification

| Spec / gate | Command evidence | Observed result |
| --- | --- | --- |
| `GOV-FILE-BRIDGE-AUTHORITY-001` and `DCL-NO-ACTION-STATUS-SEMANTICS-001` | `python scripts/bridge_claim_cli.py claim-no-action gtkb-wi5370-missing-targets-wi5335-loading-graph-repeatability-timeout --session-id 019f6bf6-3e6d-7761-be14-fb894a0e84d2 --ttl-seconds 2400` | PASS: row `32091`, `claim_kind: no_action_correction`; no implementation authority asserted. |
| `DCL-IMPLEMENTATION-PROPOSAL-SPEC-LINKAGE-MANDATORY-001` | `python scripts/bridge_applicability_preflight.py --bridge-id gtkb-wi5370-missing-targets-wi5335-loading-graph-repeatability-timeout --json` | PASS: `missing_required_specs: []`, `missing_advisory_specs: []`, packet hash `sha256:86ee8113b9d607c913213ab13648c2d8488726fef78302f9821229fb428c0a87`. |
| `DCL-VERIFIED-SPEC-DERIVED-TESTING-MANDATORY-001` | `python scripts/adr_dcl_clause_preflight.py --bridge-id gtkb-wi5370-missing-targets-wi5335-loading-graph-repeatability-timeout` | PASS for the latest GO review context before this NO-ACTION: exit 0, five clauses evaluated, two `must_apply`, zero blocking gaps. This NO-ACTION does not claim implementation or VERIFIED status. |
| `GOV-DOCUMENT-AUTHOR-PROVENANCE-001` and `GOV-WORK-TREE-HYGIENE-001` | PowerShell identity check using `ReadAllBytes`, SHA-256 hashing, first-line read, and `git hash-object` on `bridge/gtkb-wi5335-loading-graph-repeatability-timeout-004.md`. | FAIL-CLOSED as intended: observed 1,834-byte `GO` artifact with SHA-256 `7475124CADC4F6E5FE3CD9065D4ABD30372DB78D82C62243A187EF83DDB846EE`, not the approved 3,666-byte `VERIFIED` artifact with SHA-256 `952DFD8EF88B8BFA42C1ACDBCBF78E23675201DB82B0C21987EA5ED982821F72`. |
...
- `bridge/gtkb-wi5370-missing-targets-wi5335-loading-graph-repeatability-timeout-001.md` - Prime proposal with stale exact target identity.
- `bridge/gtkb-wi5370-missing-targets-wi5335-loading-graph-repeatability-timeout-002.md` - Loyal Opposition GO approving that stale exact target identity.
...
This `NO-ACTION` entry authorizes no mutation of the WI-5335 target path, archive path, source files, tests, runtime state, staged index, Git history, dispatcher state, TAFE state, database rows, releases, deployments, or external systems. Prime Builder will not implement this WI-5335 repair until Loyal Opposition files a fresh numbered verdict whose target identity matches live bytes.
