...
Archive and remove the terminal VERIFIED artifact for `gtkb-wi5399-cursor-governed-verdict-publication` because the current per-thread repair planner cannot prove a finalizer-safe implementation scope for that terminal verdict.

Planner reason: latest VERIFIED verdict has no Responds to report reference.

Source work items observed by planner: `WI-4778, WI-4871, WI-5210, WI-5399`.
...
All target paths are inside `E:\GT-KB`: `bridge/gtkb-wi5399-cursor-governed-verdict-publication-006.md` and `independent-progress-assessments/WI-5370-gtkb-wi5399-cursor-governed-verdict-publication-006.no-responds-terminal.md`.
...
- Reconfirm `bridge/gtkb-wi5399-cursor-governed-verdict-publication-006.md` is still the latest terminal VERIFIED artifact for `gtkb-wi5399-cursor-governed-verdict-publication` and is still classified as `terminal_verified_blocked_missing_scope` by `scripts/per_thread_finalization_repair.py`.
- Archive the current live bytes (1888 bytes, SHA-256 `227CC8201EFBB7A55759F43870FBC6C0C0303D16D0504C5A05C25ACF2DA5C74E`, Git blob `d86057700a5ed60b72965587e142df60f9de1427`) to `independent-progress-assessments/WI-5370-gtkb-wi5399-cursor-governed-verdict-publication-006.no-responds-terminal.md`, verify byte/hash/blob equality, and remove only `bridge/gtkb-wi5399-cursor-governed-verdict-publication-006.md`.
...
| Spec | Verification |
| --- | --- |
| `GOV-WORK-TREE-HYGIENE-001` | Run scoped `git status --short -- bridge/gtkb-wi5399-cursor-governed-verdict-publication-006.md independent-progress-assessments/WI-5370-gtkb-wi5399-cursor-governed-verdict-publication-006.no-responds-terminal.md` before and after; confirm no staged/index changes. |
| `GOV-FILE-BRIDGE-AUTHORITY-001` | Run `gt bridge show gtkb-wi5399-cursor-governed-verdict-publication --json --compact` before and after; confirm only the exact terminal file is removed from the live chain. |
...
- `gt bridge show gtkb-wi5399-cursor-governed-verdict-publication --json --compact` no longer reports `bridge/gtkb-wi5399-cursor-governed-verdict-publication-006.md` as the latest path after removal.
...
Risk is moderate because removing a terminal bridge artifact changes the live chain. The byte-identity guard and independent LO GO are mandatory. Rollback, before verification, is to restore only the archived bytes to `bridge/gtkb-wi5399-cursor-governed-verdict-publication-006.md` after revalidating the same SHA-256 and blob. Bridge files and reports remain append-only audit artifacts.

## Files Expected To Change

- `bridge/gtkb-wi5399-cursor-governed-verdict-publication-006.md`
- `independent-progress-assessments/WI-5370-gtkb-wi5399-cursor-governed-verdict-publication-006.no-responds-terminal.md`
