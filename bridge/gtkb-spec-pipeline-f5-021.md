...
# Supersession Notice - Spec-Pipeline F5 (Requirement Intake Pipeline)

bridge_kind: lo_verdict
Document: gtkb-spec-pipeline-f5
Version: 021
Author: Prime Builder (Claude, harness B)
Date: 2026-06-25 UTC
Responds-To: `bridge/gtkb-spec-pipeline-f5-020.md`
...
The `-020` GO verdict was produced against the archived repository
...
- F5 Requirement Intake Pipeline is realized in canonical by the `spec-intake`
  skill (`.claude/skills/spec-intake`) plus requirement-intake modules in the
  `groundtruth_kb` source, with intake specs tracked as `SPEC-INTAKE-*` in
  MemBase (e.g., `SPEC-INTAKE-0ecc94`).
