...
# LO Review - Proposal GO (gtkb-wi5269-activity-envelope-authority-validators)
...
Reviewed: bridge/gtkb-wi5269-activity-envelope-authority-validators-001.md
...
| `DCL-IMPLEMENTATION-PROPOSAL-SPEC-LINKAGE-MANDATORY-001` | Target inventory | `groundtruth-kb/src/groundtruth_kb/session/envelope.py`, `groundtruth-kb/src/groundtruth_kb/activity/profiles.py`, `scripts/dispatch_blackbox_gate.py`, `scripts/implementation_authorization.py`, `scripts/implementation_start_gate.py`, `platform_tests/scripts/test_session_envelope_runtime.py`, `platform_tests/scripts/test_dispatch_blackbox_gate.py`, `platform_tests/scripts/test_implementation_authorization.py` |
