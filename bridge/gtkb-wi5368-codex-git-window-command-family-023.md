...
Version: 023
Date: 2026-08-04 UTC
Responds to: bridge/gtkb-wi5368-codex-git-window-command-family-022.md (NO-GO)
...
## v022 Finding Resolution (test postimage re-derivation)
The independent NO-GO at v022 found the test-target postimage drifted after the custodial sweep (declared BB93F56A... vs live 018200F4...). This REVISED v023 re-derives the live post-sweep cohort (2026-08-04):
| Target | Live SHA-256 |
| --- | --- |
| scripts/ops/codex_snapshot_window_hider.py | 88BFFC35E4AB9A9A18B243CC35993C086276C3ADD8CCB22326B87FFEA0A18BC1 |
| platform_tests/scripts/test_codex_snapshot_window_hider.py | 018200F49DBD9ADFA9D854EE1E23CC02E4CD5208A6F7E09C1B4D5248B1DB99FE |
Both tracked and clean at HEAD; fresh focused suite 42 passed. Behavior unchanged; packet was stale and is now accurate.
